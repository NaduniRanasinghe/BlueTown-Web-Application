  ...
  <div class="museBGSize clearfix borderbox" id="page"><!-- group -->
   ...
   <div class="clearfix grpelem" id="pu1447"><!-- group -->
    ...
    <div class="grpelem" id="u3128" style="text-align: center"><!-- custom html -->
        <form action="HR_EditSalaryInfo" method ="post" style="float:center" >
          ...
          <%
            if(request.getParameter("edit_id")!=null) 
            {
               String id=request.getParameter("edit_id"); 
                ...
                try
                {
                    ...
                    pstmt=connection.prepareStatement("select * from bluelite.salary where nic=?"); 
            ...
            %>
              ...
              <input class="formtext" name="nic" value="<%=rs.getString("nic")%>" type="text">
              <br><br>
              <input class="formtext" name="basicsal" value="<%=rs.getDouble("basicSal")%>" type="number">
              <br><br>
              <input class="formtext" name="decrement" value="<%=rs.getDouble("decrement")%>" type="number">
              <br><br>
              <input class="formtext" name="othours" value="<%=rs.getDouble("othrs")%>" type="number">
              <br><br>
              <input class="formtext" name="otrate" value="<%=rs.getDouble("otrate")%>" type="number">
              <br><br>
              <input class="formtext" name="bonus" value="<%=rs.getDouble("bonus")%>" type="number">
              <br><br>
              <input class="formtext" name="commission" value="<%=rs.getDouble("commission")%>" type="number">
              <br><br>
              <input class="formbutton" type="submit" name ="btn_editsal">
              <input type="hidden" name="hidden_id" value="<%=rs.getString("nic")%>">
