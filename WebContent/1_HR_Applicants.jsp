...
sql ="select * from blueLite.contacts";
...
%>
                ...
                <tr>
                    ...
                    <td class="tg-i0kf"><form  method="get" action="FileReadPdf"> <input  type="submit"  value="View CV" /> <input type="hidden" name="cvId" value="<%=rs.getInt("cv_id")%>" /></form></td>
                    <td class="tg-i0kf"> <a href="1_HR_DeleteApplicant.jsp?delete_id=<%=rs.getInt("cv_id")%>">Delete</a></td>
               </tr>
