...
if(typeof Muse == "undefined") window.Muse = {}; window.Muse.assets = {"required":["museutils.js", "museconfig.js", "jquery.musepolyfill.bgsize.js", "jquery.musemenu.js", "jquery.watch.js", "webpro.js", "musewpdisclosure.js", "require.js", "new-finance-entry.css"], "outOfDate":[]};
  ...
  <link rel="stylesheet" type="text/css" href="css/new-asset-entry.css?crc=3904585476" id="pagesheet"/>
  <!-- IE-only CSS -->
  <!--[if lt IE 9]>
   ...
   <div class="clearfix grpelem" id="pu1447"><!-- group -->
    <div class="browser_width grpelem" id="u1447-bw">
     <div class="size_browser_width" id="u1447"><!-- custom html -->
			...
			<a href="asset-information-portal.jsp"><button id= "navigation">Back</button></a>
    ...
    <div class="grpelem" id="u2513" style="text-align: center"><!-- custom html -->
        ...
        <form action="Finance_AddAssetEntryController" method="post" name="vform" onsubmit="return Validate()">
        	<p id="name_error" class="error_text"></p>
            <input class="formtext" name="name" placeholder= "Asset Name" type="text" required>
            <br><br>
            <p id="type_error" class="error_text"></p>
            <select class="formmenu" name="type" required> 
            	<option value="" selected disabled hidden>-Select Type-</option>
                <option value="Building">Building</option>
                <option value="Computer/Laptop/Tablet etc.">Computer/Laptop/Tablet etc.</option>
            ...
            <br><br>
            <input class="formtext" name="additional" placeholder= "Additional Details (Optional)" type="text">
            <br><br>
            <input class="formtext" name="otherIDs" placeholder= "Other IDs (if any)" type="text">
            <br><br>
            <p id="value_error" class="error_text"></p>
            <input class="formtext" name="value" placeholder= "Value" type="number" min="0.01" max="999999999.99" step="0.01" required>
            <br><br>
            <input class="formbutton" type="submit"  name="addEntryBtn" value="Confirm">
            <br><br><a href="asset-information-portal.jsp"><input class="formbutton" type="button"  name="btn_back" value="Cancel"></a>
        </form>
...
<script type="text/javascript">
	...
	var name1 = document.forms["vform"]["name"];
	var value = document.forms["vform"]["value"];
	var type1 = document.forms["vform"]["type"];
	...
	value.addEventListener("blur", valueVerify, true);
	type1.addEventListener("blur", typeVerify, true);
	
	//validation function
	function Validate() {
		if (name1.value == "") {
			name1.style.border = "2px solid #962e2e";
			black_box.style.height = "500px";
		...
		if (value.value == "") {
			value.style.border = "2px solid #962e2e";
			black_box.style.height = "500px";
			value_error.textContent = "*Value is required.";
			value.focus();
			return false;
		}
		
		if (type1.value == "") {
			type.style.border = "2px solid #962e2e";
			black_box.style.height = "500px";
		...
		if (value.value < 0.01 || value.value > 999999999.99) {
			value.style.border = "2px solid #962e2e";
			black_box.style.height = "500px";
			value_error.textContent = "*Invalid input.";
			value.focus();
			return false;
		}
	}
