...
if(typeof Muse == "undefined") window.Muse = {}; window.Muse.assets = {"required":["museutils.js", "museconfig.js", "jquery.musepolyfill.bgsize.js", "jquery.musemenu.js", "jquery.watch.js", "webpro.js", "musewpdisclosure.js", "require.js", "employee-registration.css"], "outOfDate":[]};
  ...
  <link rel="stylesheet" type="text/css" href="css/EditEmployeeInfo.css?crc=126118698" id="pagesheet"/>
  <!-- IE-only CSS -->
  <!--[if lt IE 9]>
  ...
  <div class="museBGSize clearfix borderbox" id="page"><!-- group -->
   ...
   <div class="clearfix grpelem" id="pu1447"><!-- group -->
    ...
    <div class="grpelem" id="u3128" style="text-align: center"><!-- custom html -->
        <form action="HR_EditEmployee" method= "post" style="float:center;">
            ...
            if(request.getParameter("edit_id")!=null) 
            {
                ...
                try
                {
                    ...
                    pstmt=connection.prepareStatement("select * from bluelite.employee where id=?"); 
                    pstmt.setInt(1,id);
            ...
            %>
        	  ...
        	  <p style="color:white; text-align:left; margin-left: 50px">First Name:</p>
              <input class="formtext" name="fname" value="<%=rs.getString("fname")%>" type="text">
              <br><br>
              <p style="color:white; text-align:left; margin-left: 50px">Last Name:</p>
              <input class="formtext" name="lname" value="<%=rs.getString("lname")%>" type="text">
              <br><br>
              <p style="color:white; text-align:left; margin-left: 50px">NIC:</p>
              <input class="formtext" name="nic" value="<%=rs.getString("empnic")%>" type="text">
              <br><br>
              <p style="color:white; text-align:left; margin-left: 50px">Department:</p>
            ...
            <br><br>
            <p style="color:white; text-align:left; margin-left: 50px">Position:</p>
            ...
            <br><br>
            <p style="color:white; text-align:left; margin-left: 50px">Email:</p>
              <input class="formtext" name="email" value="<%=rs.getString("email")%>" type="email">
              <br><br>
              <p style="color:white; text-align:left; margin-left: 50px">Mobile No:</p>
            <input class="formtext" name="mobilenum" value="<%=rs.getString("contact")%>" type="text">
            <br><br>
            <p style="color:white; text-align:left; margin-left: 50px">Address Line 1:</p>
            <input class="formtext" name="address1" value="<%=rs.getString("address1")%>" type="text">
            <br><br>
            <p style="color:white; text-align:left; margin-left: 50px">Address Line 2:</p>
            <input class="formtext" name="address2" value="<%=rs.getString("address2")%>" type="text">
            <br><br>
           
            <p style="color:white; text-align:left; margin-left: 50px">Gender:</p>
            ...
            <br><br>
              <input class="formbutton" type="submit" name="btn_editemp">
