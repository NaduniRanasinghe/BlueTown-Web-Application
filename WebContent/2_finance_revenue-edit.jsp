  ...
  <div class="museBGSize clearfix borderbox" id="page"><!-- group -->
   ...
   <div class="clearfix grpelem" id="pu1447"><!-- group -->
    ...
    <div class="para1 clearfix grpelem" id="u1652-4"><!-- content -->
     <p>Edit Revenue Record</p>
    </div>
    <div class="grpelem" id="u2513" style="text-align: center"><!-- custom html -->
        <form action="Finance_EditFinanceEntryController" method="post">
        <% 
        if(request.getParameter("edit_id")!=null)
        {
           ...
           try
           {
        	   ...
        	   pstmt = conn.prepareStatement("select * from bluelite.revenue where ID=?");
        	   pstmt.setInt(1,id);
        	   ...
        	   {     	
        %>
            <input class="formtext" name="year" placeholder="Year" type="number" value="<%=rs.getInt("Year") %>">
            <br><br>
            <select class="formmenu" name="month" value="<%=rs.getString("Month") %>">
            	<option value="<%=rs.getString("Month") %>" selected disabled hidden><%=rs.getString("Month") %></option>
            ...
            <br><br>
            <input class="formtext" name="review" placeholder= "Review" type="text" value="<%=rs.getString("Review") %>">
            <br><br>
            <input class="formtext" name="revenue" placeholder= "Monthly Revenue" type="number" min="0" step="0.01" value="<%=rs.getDouble("Revenue") %>">
            <br><br>
