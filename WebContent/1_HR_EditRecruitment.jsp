...
if(typeof Muse == "undefined") window.Muse = {}; window.Muse.assets = {"required":["museutils.js", "museconfig.js", "jquery.musepolyfill.bgsize.js", "jquery.musemenu.js", "jquery.watch.js", "webpro.js", "musewpdisclosure.js", "require.js", "new-finance-entry.css"], "outOfDate":[]};
  ...
  <link rel="stylesheet" type="text/css" href="css/rec.css?crc=3904585476" id="pagesheet"/>
  <!-- IE-only CSS -->
  <!--[if lt IE 9]>
  ...
  <div class="museBGSize clearfix borderbox" id="page"><!-- group -->
   ...
   <div class="clearfix grpelem" id="pu1447"><!-- group -->
    ...
    <div class="grpelem" id="u2513" style="text-align: center"><!-- custom html -->
        <form action="HR_EditCareer" method="post">
            ...
            if(request.getParameter("edit_id")!=null) 
            {
                ...
                try
                {
                    ...
                    pstmt=connection.prepareStatement("select * from bluelite.career where id=?"); 
                    pstmt.setInt(1,id);
            ...
            <br><br>
            <input class="formtext" name="supervisor" value="<%=rs.getString("supervisor")%>" type="text">
            <br><br>
            <input value="<%=rs.getString("exdate")%>" class="formtext" name= "date" type="text" onfocus="(this.type='date')" onblur="(this.type='text')" >
            <br><br>
          <select class="formmenu" name="status">
            ...
            <br><br>
            <textarea id="textarea1" rows="4" cols="45" name = "description" value="<%=rs.getString("jobdDescription")%>"></textarea>
            <br><br>
            <input class="formbutton" type="submit"  name="editEntryBtn">
