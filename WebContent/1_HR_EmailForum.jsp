...
sql ="select * from bluelite.employee e inner join bluelite.salary s on e.empnic = s.nic where e.empnic like '%"+nic+"%' ";
...
%>
   ...
   <h3><%=request.getAttribute("Message")%></h3> 
        <form action="HR_EmailSendingServlet" method="post">
        	<input class="formtext" name="recipient" placeholder= "Recipient Address" type="email">
            <br><br>
          	<input class="formtext" name="subject" placeholder= "Subject" type="text" required>
            
           
            <br><br>
            <textarea id="textarea1" rows="4" cols="45" name="content" placeholder="Content"></textarea>
            <br><br>
