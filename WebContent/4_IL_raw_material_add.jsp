  ...
  <div class="museBGSize clearfix borderbox" id="page"><!-- group -->
   ...
   <div class="clearfix grpelem" id="pu1447"><!-- group -->
    ...
    <div class="para1 clearfix grpelem" id="u1652-4"><!-- content -->
     <p>Raw Material Inventory Form</p>
    </div>
    <div class="grpelem" id="u2513" style="text-align: center"><!-- custom html -->
    
        <form method="POST" action="IL_RawMaterialAddController" style="float:center" onsubmit="return total(this);">
        
            <input class="formtext" name="type" placeholder="Material Name" type="text" pattern="^[a-z A-Z]+$" title="Please include characters(a-z A-Z) only!" required>
            <br><br>
            <input class="formtext" name="quantity" id="quantity" placeholder= "Quantity" type="number" step="any" min="0" pattern="[0-9]*[.,]?[0-9]+" title="Please enter numerals or decimal values only!" required>
            <br><br>
            <select class="formtext" name="unit" required>
            ...
            <br><br>
            <input class="formtext" name="unitprice" id="unitprice" placeholder= "Unit Price" type="number" step="any" min="0" pattern="[0-9]*[.,]?[0-9]+" title="Please enter numerals or decimal values only!" required>
            <br><br>
            <input class="formtext" name="quota" id="quota" placeholder= "Minimum Quota" type="number" step="any" min="0" pattern="[0-9]*[.,]?[0-9]+" title="Please enter numerals or decimal values only!" required>
            <br><br>
            <input type="hidden" name="hidden_total" id="hidden_total">
            <input class="formbutton" type="submit" name="add" value="INSERT" onclick="return check(this)">
