  ...
  <div class="museBGSize clearfix borderbox" id="page"><!-- group -->
   <div class="clearfix grpelem" id="pu133"><!-- group -->
    ...
    <div class="clearfix" id="u1054-6"><!-- content -->
     <p id="u1054-2">Ravindu Madushan</p>
     <p id="u1054-4">Site Manager</p>
    </div>
   </div>
   <div class="clearfix grpelem" id="pu1447"><!-- group -->
    ...
    <div class="clip_frame grpelem" id="u1139"><!-- image -->
     <img class="block" id="u1139_img" src="images/" alt="" data-heightwidthratio="1" data-image-width="143" data-image-height="143"/>
    </div>
    ...
    <div class="clearfix grpelem" id="u1149-14"><!-- content -->
     ...
     <p id="u1149-10">Address</p>
     <p id="u1149-12">Employee Since</p>
    </div>
    <div class="clearfix grpelem" id="u1155-14"><!-- content -->
     <p id="u1155-2">Ravindu Madushan</p>
     <p id="u1155-4">961291658V</p>
     <p id="u1155-6">rvndmadushan@bluetown.com</p>
     <p id="u1155-8">0778584449</p>
     <p id="u1155-10">75, Halgasthota,Katunayake</p>
     <p id="u1155-12">08/March/2010</p>
    </div>
    ...
    <a href=""><button id="u1158"><p class="button-text">Edit Profile</p></button></a>
    <a href="8_Site_site_table.jsp"><button id="u1170"><p class="button-text">Site Details</p></button></a>
    <a href="8_Site_material_table.jsp"><button id="u1161"><p class="button-text">Materials</p></button></a>
    <a href="8_Site_machinery_table.jsp"><button id="u1167"><p class="button-text">Machineries</p></button></a>
    <a href="8_Site_report_details.jsp"><button id="u1164"><p class="button-text">Generate Reports</p></button></a>
    <a href=""><button id="u1164123"><p class="button-text">Information Portal</p></button></a>
