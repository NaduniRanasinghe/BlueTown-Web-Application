 ...
 <body>
  <div class="museBGSize clearfix borderbox" id="page"><!-- group -->
   ...
   <div class="clearfix grpelem" id="pu1447"><!-- group -->
    ...
    <a href="8_Site_machinery_report.jsp"><button id="u1170"><p class="button-text">Machinery Details</p></button></a>
    <a href="8_Site_material_report.jsp"><button id="u1164123"><p class="button-text">Material Report</p></button></a>
    <a href="8_Site_site_report.jsp"><button id="u1167"><p class="button-text">Site Report</p></button></a>
