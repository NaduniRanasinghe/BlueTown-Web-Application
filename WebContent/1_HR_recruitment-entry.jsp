  ...
  <div class="museBGSize clearfix borderbox" id="page"><!-- group -->
   ...
   <div class="clearfix grpelem" id="pu1447"><!-- group -->
    ...
    <div class="grpelem" id="u2513" style="text-align: center"><!-- custom html -->
        <form action="HR_AddCareer" method="post">
            ...
            <br><br>
            <input class="formtext" name="supervisor" placeholder= "Supervisor's Name" type="text">
            <br><br>
          ...
          <select class="formmenu" name="status">
            ...
            <br><br>
            <textarea id="textarea1" rows="4" cols="45" name = "description" placeholder="Job Description"></textarea>
            <br><br>
            <input class="formbutton" type="submit"  name="addEntryBtn">
        </form>
