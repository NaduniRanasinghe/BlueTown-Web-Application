  ...
  <div class="museBGSize clearfix borderbox" id="page"><!-- group -->
   <div class="clearfix grpelem" id="pu133"><!-- group -->
    <div class="transition clip_frame" id="u133"><!-- image -->
     <a href="1_HR_career-information-portal.jsp"> <img class="block" id="u133_img" src="images/contact%20us%20icon.png?crc=3895358489" alt="" data-heightwidthratio="0.7647058823529411" data-image-width="34" data-image-height="26"/></a>
    </div>
...
%>
     ...
     <div class="MenuItemContainer clearfix grpelem" id="u1296"><!-- vertical box -->
      ...
      <div class="SubMenu MenuLevel1 clearfix" id="u1301"><!-- vertical box -->
       <ul class="SubMenuView clearfix colelem" id="u1302"><!-- vertical box -->
        <li class="MenuItemContainer clearfix colelem" id="u1303"><!-- horizontal box --><div class="MenuItem MenuItemWithSubMenu rounded-corners clearfix grpelem" id="u1306"><!-- horizontal box --><div class="MenuItemLabel NoWrap clearfix grpelem" id="u1309-4"><!-- content --><div id="u1309-3"><p><a href="3_CRM_Login.jsp">Sign Out</a></p></div></div></div></li>
       </ul>
      </div>
     </div>
    </nav>
   ...
   <div class="clearfix grpelem" id="pu1447"><!-- group -->
    ...
    <div class="clearfix grpelem" id="u1314-4"><!-- content -->
     ...
     <p id="u1322-8">Salary</p>
     <p id="u1322-10">Address</p>
    ...
    <div class="clearfix grpelem" id="u1317-14"><!-- content -->
     ...
     <p id="u1317-8"><%=rs.getDouble("total")%></p>
