  ...
  <div class="museBGSize clearfix borderbox" id="page"><!-- group -->
   ...
   <div class="clearfix grpelem" id="pu1447"><!-- group -->
    ...
    <div class="grpelem" id="u2513" style="text-align: center"><!-- custom html -->
        <form action="Event_EditEvent" method="post" style="float:center;">
           <%
            if(request.getParameter("edit_id")!=null) 
            {
                ...
                try
                {
                    ...
                    pstmt=connection.prepareStatement("select * from bluelite.Event where id=?"); 
                    pstmt.setInt(1,id);
                    ...
                    {
            %>
            <input class="formtext" name="eventname" value="<%=rs.getString("eventname")%>" type="text">
            <br><br>
            <input class="formtext" name="description"  value="<%=rs.getString("description")%>" type="text">
            <br><br>
            ...
            <br><br>
            <input class="formtext" name="estimatedbudget"  value="<%=rs.getDouble("estimateBudget")%>" type="text">
            <br><br>
            <input class="formtext" name="location"  value="<%=rs.getString("location")%>" type="text">
            <br><br>
