...
%>
        ...
        <nav class="MenuBar clearfix" id="menuu4014"><!-- horizontal box -->
            <div class="MenuItemContainer clearfix grpelem" id="u4015"><!-- vertical box -->
                <div class="MenuItem MenuItemWithSubMenu borderbox museBGSize clearfix colelem" ><!-- horizontal box -->
...
<table>
					<tr>
						...
						<td  style="padding: 10px">
							<a href="1_HR_EmployeeRegistration.jsp"><button>Add New Record</button></a>
						</td>
						<td  style="padding: 10px">
							<a href="1_HR_EmailForum.jsp"><button>Email Forum</button></a>
						</td>
						<td  style="padding: 10px">
							<a href="HR_Emp_Report"><button>Employees Report</button></a>
						</td>
            ...
            <table class="tg">
                ...
                <tr>
                    ...
                    <th class="tg-ggay">Department</th>
                    <th class="tg-ggay">Post</th>
...
try{ 
connection1 = DBConnection.createConnection();
statement1=connection1.createStatement();
String query=request.getParameter("q");
String sql1;
if(query !=null){
	
	 sql1 ="select * from bluelite.employee where lname like '%"+query+"%' or fname like'%"+query+"%' or empnic like'%"+query+"%'";
}else{

sql1 ="select * from blueLite.employee";
...
%>
                ...
                <tr>
                   ...
                   <td ><%=rs1.getString("fname")%> <%=rs1.getString("lname")%></td>
                    <td ><%=rs1.getString("address1")%> <%=rs1.getString("address2")%> </td>
                    <td><%=rs1.getString("empnic")%></td>
                    ...
                    <td class="tg-i0kf"><a href="1_HR_EditEmployeeInfo.jsp?edit_id=<%=rs1.getInt("id")%>">Edit</a></td>
                   
                    <td class="tg-i0kf"><a href="1_HR_DeleteEmployee.jsp?delete_id=<%=rs1.getInt("id")%>">Delete</a></td>
