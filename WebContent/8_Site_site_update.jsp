...
<script type="text/javascript"> 
        function validate(form)
        {
            ...
            else if(!alpha.test(form.siteOwner.value)){
        ...
        <%
            if(request.getParameter("update_id")!=null) 
            {
                ...
                try
                {
                    ...
                    pstmt = conn.prepareStatement("select * from sites2 where siteID=?"); 
                    pstmt.setInt(1,id);
         ...
         <form method="POST" action="Site_SiteUpdateController" style="float:center" onsubmit="return validate(this);">
            <input class="formtext" name="siteName" required="required" value="<%= rs.getString("siteName") %>" placeholder="Site Name" type="text">
            <br><br>
            <input class="formtext" name="siteOwnerName" required="required" value="<%= rs.getString("siteOwnerName") %>" placeholder= "Site Owner Name" type="text">
            <br><br>
            <input class="formtext" name="estimatedCost" required="required" value="<%= rs.getDouble("estimatedCost") %>" placeholder= "Estimated Cost" type="number">
            <br><br>
            <input class="formtext" name="receivedAmount" required="required" value="<%= rs.getDouble("receivedAmount") %>" placeholder= "Received Amount" type="number">
            <br><br>
            <input class="formtext" name="handOverDate" required="required" value="<%= rs.getString("handOverDate") %>" placeholder= "Hand Over Date" type="text" onfocus="(this.type='date')" onblur="(this.type='text')">
            <br><br>
            <input class="formbutton" type="submit" name="update" value="UPDATE">
            <input type="hidden" name="hidden_id" value="<%=rs.getInt("siteID")%>">
