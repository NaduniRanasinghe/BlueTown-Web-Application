...
if(typeof Muse == "undefined") window.Muse = {}; window.Muse.assets = {"required":["museutils.js", "museconfig.js", "jquery.musepolyfill.bgsize.js", "jquery.musemenu.js", "jquery.watch.js", "webpro.js", "musewpdisclosure.js", "require.js", "new-finance-entry.css"], "outOfDate":[]};
  ...
  <![endif]-->
	...
	function total(form) {
    	...
    	var mCost = document.getElementById("maintenance_cost").value;
    	var fCost = document.getElementById("fuel_cost").value;
    	
    	var total = parseFloat(cost) + parseFloat(mCost) + parseFloat(fCost);
  ...
  <div class="museBGSize clearfix borderbox" id="page"><!-- group -->
   <div class="clearfix grpelem" id="pu133"><!-- group -->
    ...
    <div class="clearfix" id="u3499-6"><!-- content -->
     <p id="u3499-2">Roshan Gunananda</p>
     <p id="u3499-4">Inventory & Logistics Manager</p>
    </div>
   </div>
        ...
        <%
            if(request.getParameter("update_id")!=null) 
            {
                ...
                try
                {
                    ...
                    pstmt = conn.prepareStatement("select * from bluelite.logistics where id=?"); 
                    pstmt.setInt(1,id);
         ...
         <form method="POST" action="IL_LogisticsUpdateController" style="float:center">
            <input class="formtext" name="type" value="<%= rs.getString("type") %>" placeholder="Vehicle Name" type="text" pattern="^[a-z A-Z]+$" title="Please include characters(a-z A-Z) only!" autofocus required>
            <br><br>
            <input class="formtext" name="cost" value="<%= rs.getDouble("cost") %>" placeholder= "Vehicle Cost" type="number" step="any" min="0" pattern="[0-9]*[.,]?[0-9]+" required>
            <input type="hidden" name="cost" id="cost" value="cost">
            <br><br>
            <input class="formtext" name="maintenance_cost" value="<%= rs.getDouble("maintenance_cost") %>" placeholder= "Maintenance Cost" type="number" min="0" type="number" step="any" min="0" pattern="[0-9]*[.,]?[0-9]+" required>
            <input type="hidden" name="maintenance_cost" id="maintenance_cost" value="maintenance_cost">
            <br><br>
            <input class="formtext" name="fuel_cost" value="<%= rs.getDouble("fuel_cost") %>" placeholder= "Fuel Cost" type="number" min="0" type="number" step="any" min="0" pattern="[0-9]*[.,]?[0-9]+" required>
            <input type="hidden" name="fuel_cost" id="fuel_cost" value="fuel_cost">
            <br><br>
            <input type="hidden" name="hidden_id" value="<%= rs.getInt("id") %>">
            <input type="hidden" name="hidden_total" value="<%= rs.getDouble("total") %>">
            <input type="hidden" name="hidden_total" value="hidden_total">
            <input class="formbutton" type="submit" name="update" value="UPDATE" onsubmit="return total()">
