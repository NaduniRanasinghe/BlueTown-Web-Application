...
if(typeof Muse == "undefined") window.Muse = {}; window.Muse.assets = {"required":["museutils.js", "museconfig.js", "jquery.musepolyfill.bgsize.js", "jquery.musemenu.js", "jquery.watch.js", "webpro.js", "musewpdisclosure.js", "require.js", "finance-manager-profile.css"], "outOfDate":[]};
  ...
  <title>OR Manager Profile</title>
  <!-- CSS -->
  ...
  <link rel="stylesheet" type="text/css" href="css/finance-manager-profile.css?crc=3916206790" id="pagesheet"/>
  <!-- IE-only CSS -->
  <!--[if lt IE 9]>
...
%>
   ...
   <div class="clearfix grpelem" id="pu1447"><!-- group -->
    ...
    <div class="clearfix grpelem" id="u1155-14"><!-- content -->
     ...
     <p id="u1155-6">ormgr@bluetown.com</p>
    ...
    <div class="grpelem" id="u1158"><!-- simple frame --></div>
    <div class="grpelem" id="u1170"><!-- simple frame --></div>
    <div class="grpelem" id="u1161"><!-- simple frame --></div>
    <div class="grpelem" id="u1167"><!-- simple frame --></div>
    <div class="grpelem" id="u1164"><!-- simple frame --></div>
        <div class="grpelem" id="u1169"><!-- simple frame --></div>
    
    
    <button id="u1158"><p class="button-text">Edit Profile</p></button>
    <a href="6_ORM_sevicePortal.jsp"><button id="u1170"><p class="button-text">Services</p></button></a>
    <a href="6_ORM_MetPortal.jsp"><button id="u1161"><p class="button-text">Materials</p></button></a>
    <a href="6_ORM_HRPortal.jsp"><button id="u1167"><p class="button-text">Human Resource</p></button></a>
    <a href="6_ORM_REPORT.jsp"><button id="u1164"><p class="button-text">Report</p></button></a>
    <a href="6_ORM_Calculation.jsp"><button id="u1169 class="button-text">Calculation</p></button></a>/
         </div>
  </div>
  <!-- JS includes -->
  <script type="text/javascript">
