  ...
  <![endif]-->
	...
	<!-- <script type="text/javascript"> 
     ...
     <script type="text/javascript">
     	...
     	function demo(){
     		document.getElementById("materialName").value="Cement";
  ...
  <div class="museBGSize clearfix borderbox" id="page"><!-- group -->
   ...
   <div class="clearfix grpelem" id="pu1447"><!-- group -->
    ...
    <div class="grpelem" id="u2513" style="text-align: center"><!-- custom html -->
        ...
        <form method="POST" action="Site_MaterialAddController" style="float:center" onsubmit="return validate(this);">
            <select class="formtext" name="materialName" required="required" style="width:200px" id="materialName">
            	<option value="">!--select material--!</option>
            	<option value="Fired Bricks">Fired Bricks</option>
            	<option value="Clay Blocks">Clay Blocks</option>
            ...
            <br><br>
            <input style="width:180px" id="quantity"   class="formtext" name="quantity" required="required" min="1" max="80000" placeholder= "Quantity" type="number">
            <br><br>
            
            <input class="formbutton" type="submit" name="add" value="ADD">
            <br><br>
            <input class="formbutton" type="reset" name="reset" value="RESET">
            <br><br>
            <!-- <input type = "submit" name="add" value="ADD MATERIAL" 
             		style = "margin:0px; padding:0px; background-color: #0b0470; color: white; height: 30px; width: 150px;border-radius: 15px; float:left" 
             		onclick="window.location.href='material_add.jsp'"> -->
