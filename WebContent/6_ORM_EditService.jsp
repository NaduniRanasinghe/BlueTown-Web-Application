  ...
  <div class="museBGSize clearfix borderbox" id="page"><!-- group -->
   ...
   <div class="clearfix grpelem" id="pu1447"><!-- group -->
    ...
    <div class="grpelem" id="u3128" style="text-align: center"><!-- custom html -->
        <form action="ORM_EditHR" method="post" style= "float:center;">
        ...
        <%
            if(request.getParameter("edit_id")!=null) 
            {
                ...
                try
                {
                    ...
                    pstmt=connection.prepareStatement("select * from bluelite.hrportal where id=?"); 
                    pstmt.setInt(1,id);
                    ...
                    {
            %>
              <input class="formtext" name=" Name" value="<%=rs.getString("namehr")%>" type="text">
              <br><br>
