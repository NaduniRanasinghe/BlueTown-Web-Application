...
<head>
    ...
    <title>Task Information Portal</title>
    <!-- CSS -->
...
%> 
                ...
                <tr>
                    ...
                    <th class="tg-ggay">Task Name</th>
                    <th class="tg-ggay">Budget</th>
...
if(query !=null){
	 ...
	 sql ="select * from bluelite.task where eventname like '%"+query+"%' or Budget like'%"+query+"%' or Description like'%"+query+"%'";
}else{

sql ="select * from blueLite.task";
...
%>
                ...
                <tr>
                    ...
                    <td class="tg-i0kf"><%=rs.getString("taskname")%></td>
                    <td class="tg-i0kf"><%=rs.getDouble("Budget")%></td>
                    <td class="tg-i0kf"><%=rs.getString("description")%></td>
                   
                   
                    
                    <td class="tg-i0kf"><a href="Task_edit.jsp?edit_id=<%=rs.getInt("id")%>">Edit</a></td>
                    <td class="tg-i0kf"><a href="task_delete.jsp?delete_id=<%=rs.getInt("id")%>">Delete</a></td>
