...
<head>
    ...
    <title>Sales Information Portal</title>
    <!-- CSS -->
...
%> 
                ...
                <tr>
                	...
                	<th class="tg-ggay">saleID</th>
                    <th class="tg-ggay">totPay</th>
                    <th class="tg-ggay">initialPay</th>
                    <th class="tg-ggay">instalCount</th>
                    <th class="tg-ggay">cusID</th>
...
if(query !=null){
	 ...
	 sql ="select * from bluelite.sales where saleID like '%"+query+"%' or cusID like'%"+query+"%'";
}else{

sql ="select * from blueLite.sales";
...
%>
                ...
                <tr>
                    ...
                    <td class="tg-i0kf"><%=rs.getInt("saleID")%></td>
                   <td class="tg-i0kf"><%=rs.getDouble("totPay")%></td>
                    <td class="tg-i0kf"><%=rs.getDouble("intPay")%></td>
                    <td class="tg-i0kf"><%=rs.getInt("instlCount")%></td>
                    <td class="tg-i0kf"><%=rs.getInt("cusID")%></td>
                    
                   
                    
                    <td class="tg-i0kf"><a href="5_Sales_EditSale.jsp?edit_id=<%=rs.getInt("id")%>">Edit</a></td>
                    <td class="tg-i0kf"><a href="5_Sales_deleteSales.jsp?delete_id=<%=rs.getInt("id")%>">Delete</a></td>
