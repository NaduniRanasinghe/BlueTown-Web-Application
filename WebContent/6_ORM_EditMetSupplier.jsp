      ...
      <%
            if(request.getParameter("edit_id")!=null) 
            {
                ...
                try
                {
                    ...
                    pstmt=connection.prepareStatement("select * from bluelite.metPortal where id=?"); 
                    pstmt.setInt(1,id);
        ...
        <form action="ORM_EditMet"method="post" style="float:center;">
              <input class="formtext" name="Company Name" value="<%=rs.getString("company_name")%>" type="text">
              <br><br>
              <input class="formtext" name="address1" value="<%=rs.getString("address_line_1")%>" type="text">
              <br><br>
            <input class="formtext" name="address2" value="<%=rs.getString("address_line_2")%>" type="text">
            <br><br>
            <input class="formtext" name="city" value="<%=rs.getString("city")%>" type="text">
            <br><br>
            <input class="formtext" name="email" value="<%=rs.getString("email")%>" type="email">
            <br><br>
            <input class="formtext" name="mobile" value="<%=rs.getString("mobile")%>" type="text">
            <br><br>
            <input class="formtext" name="item Name" value="<%=rs.getString("item_name")%>" type="number">
            <br><br>
            <input class="formtext" name="unit price" value="<%=rs.getString("unit_price")%>" type="number">
            <br><br>
            ...
            <br><br>
              <input class="formbutton" type="submit"name="edit_btn">
