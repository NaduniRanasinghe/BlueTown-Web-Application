...
<div class="clearfix borderbox" id="page"><!-- group -->
    ...
    <div class="clearfix grpelem" id="pu1447"><!-- group -->
        ...
        <div class="para1 clearfix grpelem" id="u4039-4"><!-- content -->
            <p>Logistics Information Portal</p>
        </div>
        <div class="grpelem" id="invent1"><!-- custom html -->
            <style type="text/css">
                .tg  {margin-left: -150px; border-collapse:collapse;border-spacing:0;border-color:transparent;}
            ...
            <input type = "submit" name="add" value="ADD VEHICLE" style = "background-color: gold; height: 30px; width: 150px;border-radius: 15px"
                 onclick="window.location.href='4_IL_logistics_add.jsp'">
            ...
            <table class="tg" id="equip">
                <tr>
                    ...
                    <th class="tg-ggay">Vehicle Type&nbsp; &nbsp; &nbsp; &nbsp;</th>
                    <th class="tg-ggay">Purchase Cost&nbsp; &nbsp; &nbsp; &nbsp;</th>
                    <th class="tg-ggay">Maintenance Cost&nbsp; &nbsp; &nbsp; &nbsp;</th>
                    <th class="tg-ggay">Fuel Charges&nbsp; &nbsp; &nbsp; &nbsp;</th>
                ...
                <%
                     ...
                     String sql = "select * from bluelite.logistics order by id;";
                ...
                %>
                     <tr>
                         ...
                         <td class="tg-fhq0"><%= rs.getDouble("cost") %></td>
                         <td class="tg-fhq0"><%= rs.getDouble("maintenance_cost") %></td>
                         <td class="tg-fhq0"><%= rs.getDouble("fuel_cost") %></td>
                         <td class="tg-fhq0"><%= rs.getDouble("total") %></td>
                         <td><a href="4_IL_logistics_update.jsp?update_id=<%=rs.getInt("id")%>">Update</a></td>
                         <td><a href="4_IL_logistics_delete.jsp?delete_id=<%=rs.getInt("id")%>">Delete</a></td>
                     </tr>
