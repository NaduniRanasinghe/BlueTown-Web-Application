  ...
  <div class="museBGSize clearfix borderbox" id="page"><!-- group -->
   ...
   <div class="clearfix grpelem" id="pu1447"><!-- group -->
    ...
    <div class="para1 clearfix grpelem" id="u1652-4"><!-- content -->
     <p>Apply for the Vacancy</p>
    </div>
    <div class="grpelem" id="u2513" style="text-align: center"><!-- custom html -->
        <form method="post" action="HR_FileUploadDBServlet" enctype="multipart/form-data">
        
            <br><br>
           <input class="formtext" name="firstName" placeholder= "First Name" type="text">
            <br><br>
            <input class="formtext" name="lastName" placeholder= "Last Name" type="text">
            <br><br>
            <input class="formtext" name="mobile" placeholder= "Contact Number" type="text">
            <br><br>
            <p style="color:white; text-align:left; margin-left: 50px">Upload your CV in pdf format</P>
         <input class="formtext" name="cv" type="file">
            <br><br>
