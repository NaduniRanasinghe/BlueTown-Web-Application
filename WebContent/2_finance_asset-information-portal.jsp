...
<head>
    ...
    <title>Asset Information Portal</title>
    <!-- CSS -->
...
<div class="clearfix borderbox" id="page"><!-- group -->
    ...
    <div class="clearfix grpelem" id="pu1447"><!-- group -->
        ...
        <div class="para1 clearfix grpelem" id="u4039-4"><!-- content -->
            <p>Asset Information Portal</p>
        </div>
        <div class="grpelem" id="invent1"><!-- custom html -->
            <style type="text/css">
                .tg  {margin-left: 100px; border-collapse:collapse;border-spacing:0;border-color:transparent;}
				...
				<table>
					<tr>
						...
						<td  style="padding: 10px">
							<a href="asset-entry.jsp"><button>Add New Record</button></a>
						</td>
					</tr>
				</table>
				<br><br>
				...
				<%
					try{ 
						...
						String sql;
						if(query !=null){
							sql ="select * from bluelite.asset where ID like '%"+query+"%' or Name like'%"+query+"%' ";
						}
						else{
						sql ="select * from bluelite.asset";
					}
			  ...
			  <tr>
                    ...
                    <td><%=rs.getString("OtherIDs") %></td>
                    <td><%=rs.getDouble("Value") %>0</td>
                 
                    
                    <td><a class="linkstyle" href="2_Finance_asset-edit.jsp?edit_id=<%=rs.getInt("ID")%>">Edit</a></td>
                    <td><a href="2_Finance_asset-delete.jsp?delete_id=<%=rs.getInt("ID")%>">Delete</a></td>
