  ...
  <div class="museBGSize clearfix borderbox" id="page"><!-- group -->
   ...
   <div class="clearfix grpelem" id="pu1447"><!-- group -->
    ...
    <div class="para1 clearfix grpelem" id="u1652-4"><!-- content -->
     <p>Utility Bill Entry</p>
    </div>
    <div class="grpelem" id="u2513" style="text-align: center"><!-- custom html -->
        <form action="Finance_AddBillEntryController" method="post">
            <input class="formtext" name="billNumber" placeholder= "Bill Number" type="number">
            <br><br>
			...
			<br><br>
            <input placeholder="Bill Date" class="formtext" name= "billDate" type="text" onfocus="(this.type='date')" onblur="(this.type='text')" >
            <br><br>
            <input placeholder="Due Date" class="formtext" name= "dueDate" type="text" onfocus="(this.type='date')" onblur="(this.type='text')" >
            <br><br>
            <input class="formtext" name="additional" placeholder="Additional Details" type="text">
            <br><br>
            <input class="formtext" name="payment" placeholder= "Total Payment" type="number" min="0" step="0.01">
            <br><br>
            <input class="formbutton" type="submit"  name="addEntryBtn" Value="Confirm">
            <br><br><a href="2_Finance_bill-information-portal.jsp"><input class="formbutton" type="button"  name="btn_back" value="Cancel"></a>
        </form>
