  ...
  <div class="museBGSize clearfix borderbox" id="page"><!-- group -->
   ...
   <div class="clearfix grpelem" id="pu1447"><!-- group -->
    ...
    <div class="grpelem" id="u3666" style="text-align: center"><!-- custom html -->
        <form  name="myForm" action="Sales_EditSales" method="post" onsubmit="return validateForm()" style="float:center;" >
           ...
           <%
            if(request.getParameter("edit_id")!=null) 
            {
                ...
                try
                {
                    ...
                    pstmt=connection.prepareStatement("select * from bluelite.sales where id=?"); 
                    pstmt.setInt(1,id);
            ...
            <input class="formtext" name="saleId" value="<%=rs.getInt("saleId")%>" type="text" >
            <br><br>
            <input class="formtext" name="totPay" value="<%=rs.getDouble("totPay")%>" type="text">
            <br><br>
             <input class="formtext" name="intPay" value="<%=rs.getDouble("intPay")%>"  type="text">
            <br><br>
             <input class="formtext" name="instlCount" value="<%=rs.getInt("instlCount")%>" type="text">
            <br><br>
             <input class="formtext" name="cusId" value="<%=rs.getInt("cusId")%>"  type="text">
            <br><br>
