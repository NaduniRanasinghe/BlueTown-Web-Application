...
function validateFormSale() {
	
	 
	
    var x = document.forms["myFormSale"]["saleId"].value;
    var y= document.forms["myFormSale"]["totPay"].value;
    var z= document.forms["myFormSale"]["intPay"].value;
    var p= document.forms["myFormSale"]["instlCount"].value;
    var q= document.forms["myFormSale"]["cusId"].value;
    
   
    
    
     if (isNaN(x) || x < 1 ) {
        alert("Inputs are not valid..Sale ID  should be numeric");
        return false;
    }
     ...
     if (isNaN(y) || x < 1 ) {
        alert("Inputs are not valid..Total payment should be numeric");
        return false;
    }
	...
	if(z==""){
     ...
     if (isNaN(z) || x < 1 ) {
         alert("Inputs are not valid..Intial payment should be numeric");
         return false;
    }
     ...
     if (isNaN(p) || x < 1 ) {
         alert("Inputs are not valid..Instalment count should be numeric");
         return false;
     }
     ...
     if (isNaN(q) || x < 1 ) {
         alert("Inputs are not valid..Customer id should be numeric");
         return false;
     }
  ...
  <div class="museBGSize clearfix borderbox" id="page"><!-- group -->
   ...
   <div class="clearfix grpelem" id="pu1447"><!-- group -->
    ...
    <div class="para1 clearfix grpelem" id="u3665-4"><!-- content -->
     <p>Add Sale Information</p>
    </div>
    <div class="grpelem" id="u3666" style="text-align: center"><!-- custom html -->
        <form method="post" action="Sales_AddSales" onsubmit="return validateFormSale()" style="float:center;">
            <input class="formtext" name="saleId" placeholder= "Sale ID" type="text">
            <br><br>
            <input class="formtext" name="totPay" placeholder= "Total Payment" type="text">
            <br><br>
             <input class="formtext" name="intPay" placeholder= "Intial Payment" type="text">
            <br><br>
             <input class="formtext" name="instlCount" placeholder= "Installment number" type="text">
            <br><br>
             <input class="formtext" name="cusId" placeholder= "Customer Id" type="text">
            <br><br>
            
            
            <input class="formbutton" name= "btn_add" onclick="validateFormSale()" type="submit">
        </form>
