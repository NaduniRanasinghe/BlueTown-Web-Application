  ...
  <div class="museBGSize clearfix borderbox" id="page"><!-- group -->
   ...
   <div class="clearfix grpelem" id="pu1447"><!-- group -->
    ...
    <div class="para1 clearfix grpelem" id="u1652-4"><!-- content -->
     <p>Edit Asset Record</p>
    </div>
    <div class="grpelem" id="u2513" style="text-align: center"><!-- custom html -->
        <form action="Finance_EditAssetEntryController" method="post">
        <% 
        if(request.getParameter("edit_id")!=null)
        {
           ...
           try
           {
        	   ...
        	   pstmt = conn.prepareStatement("select * from bluelite.asset where ID=?");
        	   pstmt.setInt(1,id);
        ...
        %>
        	...
        	<input class="formtext" name="name" placeholder= "Asset Name" type="text" value="<%=rs.getString("Name") %>">
            <br><br>
            
            <select class="formmenu" name="type">
            	<option value="<%=rs.getString("Type") %>" selected disabled hidden><%=rs.getString("Type") %></option>
                <option value="building">Building</option>
                <option value="pc,lap,tab">Computer/Laptop/Tablet etc.</option>
                <option value="electronics">Consumer Electronics</option>
                <option value="Furniture">Furniture</option>
                <option value="machinery">Industrial Machinery</option>
                <option value="land">Land</option>
                <option value="phones,accessory">Mobile Phones & Accessories</option>
            ...
            <input class="formtext" name="otherIDs" placeholder= "Other IDs (if any)" type="text" value="<%=rs.getString("OtherIDs") %>">
            <br><br>
            
            <input class="formtext" name="value" placeholder= "Value" type="number" min="0" step="0.01" value="<%=rs.getDouble("Value") %>0">
            <br><br>
