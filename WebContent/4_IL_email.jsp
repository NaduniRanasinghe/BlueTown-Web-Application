  ...
  <div class="museBGSize clearfix borderbox" id="page"><!-- group -->
   ...
   <div class="clearfix grpelem" id="pu1447"><!-- group -->
    ...
    <div class="grpelem" id="u2513" style="text-align: center"><!-- custom html -->
        ...
        <form method="POST" action="MailController" style="float:center">
            <input class="formtext" name="To" placeholder="To" type="text" required>
            <br><br>
            <input class="formtext" name="subject" placeholder= "Subject" type="text" required>
            <br><br>
            <textarea class="formtext" rows="5" cols="25" name="message" placeholder="Enter Message....." required></textarea>
            <br><br>
