  ...
  <![endif]-->
	...
	<script type="text/javascript"> 
	    ...
	    function total(form) {
	    	...
	    	var main = document.getElementById("maintenance_cost").value;
	    	
	    	var total = (quan * cost) + main;
        ...
        <%
            if(request.getParameter("update_id")!=null) 
            {
                ...
                try
                {
                    ...
                    pstmt = conn.prepareStatement("select * from bluelite.equipment where id=?"); 
                    pstmt.setInt(1,id);
         ...
         %>  
          ...
          <form method="POST" action="IL_EquipmentUpdateController" style="float:center" onsubmit="return total(this)">
            <input class="formtext" name="type" value="<%= rs.getString("type") %>" placeholder="Material Name" type="text">
            <br><br>
            <input class="formtext" name="quantity" value="<%= rs.getInt("quantity") %>" placeholder= "Quantity" type="number">
            <br><br>
            <input class="formtext" name="unitprice" id="unitprice" value="<%= rs.getDouble("unit_cost") %>" placeholder= "Unit Price" type="number">
            <br><br>
            <input class="formtext" name="maintenance_cost" id="maintenance_cost" value="<%= rs.getDouble("maintenance_cost") %>" placeholder= "Unit Price" type="number">
            <br><br>
