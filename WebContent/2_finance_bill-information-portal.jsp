...
<head>
    ...
    <title>Utility Bills Information Portal</title>
    <!-- CSS -->
...
<div class="clearfix borderbox" id="page"><!-- group -->
    ...
    <div class="clearfix grpelem" id="pu1447"><!-- group -->
        ...
        <div class="para1 clearfix grpelem" id="u4039-4"><!-- content -->
            <p>Utility Bills Information Portal</p>
        </div>
        <div class="grpelem" id="invent1"><!-- custom html -->
            <style type="text/css">
                .tg  {margin-left: 120px; border-collapse:collapse;border-spacing:0;border-color:transparent;}
				...
				<table>
					<tr>
						...
						<td  style="padding: 10px">
							<a href="2_finance_bill-entry.jsp"><button>Add New Record</button></a>
						</td>
					</tr>
				</table>
				<br><br>
				...
				<table class="tg">
                <tr>
                    <th class="tg-ggay">Bill Number</th>
                    <th class="tg-ggay">Type</th>
                    <th class="tg-ggay">Bill Date</th>
                    <th class="tg-ggay">Due Date</th>
                    <th class="tg-ggay">Additional Details</th>
                    <th class="tg-ggay">Payment</th>
				...
				<%
					try{ 
						...
						String sql;
						if(query !=null){
							sql ="select * from bluelite.bill where BillNumber like '%"+query+"%' or Type like'%"+query+"%' ";
						}
						else{
						sql ="select * from bluelite.bill";
					}
				...
				%>
			  <tr>
                    <td><%=rs.getInt("BillNumber")%></td>
                    <td><%=rs.getString("Type")%></td>
                    <td><%=rs.getString("BillDate")%></td>
                    <td><%=rs.getString("DueDate")%></td>
                    <td><%=rs.getString("AdditionalDetails") %></td>
                    <td><%=rs.getDouble("Payment") %>0</td>
                 
                    
                    <td><a href="2_finance_bill-edit.jsp?edit_id=<%=rs.getInt("BillNumber")%>">Edit</a></td>
                    <td><a href="2_finance_bill-delete.jsp?delete_id=<%=rs.getInt("BillNumber")%>">Delete</a></td>
