...
if(typeof Muse == "undefined") window.Muse = {}; window.Muse.assets = {"required":["museutils.js", "museconfig.js", "jquery.musepolyfill.bgsize.js", "jquery.musemenu.js", "jquery.watch.js", "webpro.js", "musewpdisclosure.js", "require.js", "employee-registration.css"], "outOfDate":[]};
</script>
<script>
</script>
  ...
  <link rel="stylesheet" type="text/css" href="css/employee-registration.css?crc=126118698" id="pagesheet"/>
  <!-- IE-only CSS -->
  <!--[if lt IE 9]>
  <link rel="stylesheet" type="text/css" href="css/iefonts_employee-registration.css?crc=3825755721"/>
  <![endif]-->
  <!-- Other scripts -->
  <script type="text/javascript">
  ...
  <![endif]-->
	...
	<script type="text/javascript">
	    function allLetter(form){
	       ...
	       if(form.nic.value == ""){
	    	   error.push("Error: NIC cannot be kept empty");
	       }
	       else if(!nic.test(form.nic.value)){
	    	   error.push("Error: Invalid NIC! Please enter a valid NIC");
	       }
	       if(form.fname.value == ""){
	    	   error.push("Error: First name cannot be kept empty");
	       }
	       else if(!name.test(form.fname.value)){
	    	   error.push("Error: Invalid characters! Please enter alphabetic words only");
	       }
	       if(form.lname.value == ""){
	    	   error.push("Error: Last name cannot be kept empty");
	       }
	       else if(!name.test(form.lname.value)){
	    	   error.push("Error: Invalid characters! Please enter alphabetic words only");
	       }
	       if(form.email.value == ""){
	    	   error.push("Error: Email cannot be kept empty");
	       }
	       if(form.mobile.value == ""){
	    	   error.push("Error: Mobile cannot be kept empty");
	       }
	       else if(!phone.test(form.mobile.value)){
	    	   error.push("Error: Invalid characters! Please enter a valid phone number");
	       }
	       if(form.address1.value == ""){
	    	   error.push("Error: Address 1 cannot be kept empty");
	       }
	       else if(!name.test(form.address1.value)){
	    	   error.push("Error: Invalid characters! Please enter a valid address");
	       }
	       if(form.address2.value == ""){
	    	   error.push("Error: Address 2 cannot be kept empty");
	       }
	       else if(!name.test(form.address2.value)){
	    	   error.push("Error: Invalid characters! Please enter a valid address");
	       }
 ...
 <body>
  <div class="museBGSize clearfix borderbox" id="page"><!-- group -->
   <div class="clearfix grpelem" id="pu133"><!-- group -->
    ...
    <div class="clearfix" id="u3532-6"><!-- content -->
     <p id="u3532-2">Dereesha Vithanage</p>
     <p id="u3532-4">Sales Manager</p>
    </div>
    <nav class="MenuBar clearfix" id="menuu3533"><!-- horizontal box -->
     <div class="MenuItemContainer clearfix grpelem" id="u3534"><!-- vertical box -->
      <div class="MenuItem MenuItemWithSubMenu borderbox museBGSize clearfix colelem" id="u1479"><!-- horizontal box -->
       <div class="MenuItemLabel NoWrap clearfix grpelem" id="u3537-3"><!-- content -->
        <p>&nbsp;</p>
       </div>
      </div>
      <div class="SubMenu MenuLevel1 clearfix" id="u3539"><!-- vertical box -->
       <ul class="SubMenuView clearfix colelem" id="u3540"><!-- vertical box -->
        <li class="MenuItemContainer clearfix colelem" id="u3541"><!-- horizontal box --><div class="MenuItem MenuItemWithSubMenu rounded-corners clearfix grpelem" id="u3544"><!-- horizontal box --><div class="MenuItemLabel NoWrap clearfix grpelem" id="u3546-4"><!-- content --><div id="u3546-3"><p>Sign Out</p></div></div></div></li>
       </ul>
      </div>
     </div>
    </nav>
   ...
   <div class="clearfix grpelem" id="pu1447"><!-- group -->
    <div class="browser_width grpelem" id="u1447-bw">
     <div class="size_browser_width" id="u1447"><!-- custom html -->
		...
		document.getElementById("nic1").value="958100566V";
		document.getElementById("fname1").value="Shaini";
		document.getElementById("lname1").value="Thenuwara";
		document.getElementById("email1").value="shainitenuwara@gmail.com";
		document.getElementById("mobile1").value="0717357875";
		document.getElementById("add1").value="Keraminiya Road";
		document.getElementById("add2").value="wathugedara";
		document.getElementById("city").value="Ambalangoda";
		document.getElementById("pass1").value="123";
    ...
    <div class="grpelem" id="fram123"><!-- simple frame --></div>
    <div class="para1 clearfix grpelem" id="u3129-4"><!-- content -->
     <p>Customer Registration</p>
    </div>
    <div class="grpelem"  id="u3128" style="text-align: center"><!-- custom html -->
        <form action="CRM_registration" method="post" style="float:center;"  onsubmit ="return allLetter(this);">
            <input class="formtext" name="nic" placeholder= "NIC" type="text" id ="nic1">
              <br><br>
              <input class="formtext" name="fname" placeholder= "First Name" type="text" id="fname1">
              <br><br>
              <input class="formtext" name="lname" placeholder="Last Name" type="text" id="lname1">
              <br><br>
            <input class="formtext" name="email" placeholder="Email" type="email" id="email1">
            <br><br>
            <input class="formtext" name="mobile" placeholder="Mobile Number" type="text" id="mobile1">
            <br><br>
            <input class="formtext" name="address1" placeholder="Address Line 1" type="text" id="add1">
            <br><br>
            <input class="formtext" name="address2" placeholder="Address Line 2" type="text" id="add2">
            <br><br>
            <input class="formtext" name="city" placeholder="City" type="text" id="city">
            <br><br>
            ...
            <br>
            <select class="formmenu" name="apartmenttype">
                <option value="basement">Basement Apartment</option>
                <option value="highrise">Condo</option>
                <option value="highrise">Highrise</option>
                <option value="highrise">Loft</option>
                <option value="lowrise">Lowrise</option>
                <option value="highrise">Microapartment</option>
                <option value="penthouse">Penthouse</option>
                <option value="villa">Villa</option>
            </select>
            <br><br>
            <select class="formmenu" name="site">
           ...
           <br><br>
            <input class="formtext" name="password" placeholder="Password" type="password" id="pass1">
            <br><br>
            <input class="formtext" name="password" placeholder="Confirm Password" type="password" id="pass2">
            <br><br>
            <label class="container2">Agree to Terms & Conditions
                <input type="checkbox" checked="checked">
                <span class="checkmark2"></span>
            </label>
            <br><br>
              <input class="formbutton" type="submit"  herf="http://localhost:8080/Test1/succuss.jsp">
        </form>
         <br>    <button value="Demo" onclick="demo()">Demo</button>
    </div>
   </div>
  </div>
  <!-- JS includes -->
