	...
	<script>
	   function validate(form){
		   ...
		   if(form.eventname.value == ""){
			   error.push("Error: Event name cannot be left blank");
		   }
		   else if(!ch.test(form.eventname.value)){
			   error.push("Error: Invalid characters found in name field");
		   }
		   if(form.description.value == ""){
			   error.push("Error: Description cannot be left blank");
		   }
		   else if(!ch.test(form.description.value)){
			   error.push("Error: Invalid characters found in description field");
		   }
		   if(form.estimatedbudget.value == ""){
			   error.push("Error: Budget cannot be left blank");
		   }
		   else if(!num.test(form.estimatedbudget.value)){
			   error.push("Error: Invalid characters found in budget field");
		   }
		   if(form.location.value == ""){
			   error.push("Error: location cannot be left blank");
		   }
		   else if(!ch.test(form.location.value)){
			   error.push("Error: Invalid characters found in Location field");
		   }
  ...
  <div class="museBGSize clearfix borderbox" id="page"><!-- group -->
   <div class="clearfix grpelem" id="pu133"><!-- group -->
    ...
    <div class="clearfix" id="u3499-6"><!-- content -->
     <p id="u3499-2">Nalaka Jayawardene</p>
     <p id="u3499-4">Marketing Manager</p>
    </div>
   </div>
   <div class="clearfix grpelem" id="pu1447"><!-- group -->
    ...
    <div class="grpelem" id="blackfram2"><!-- simple frame --></div>
    <div class="para1 clearfix grpelem" id="u1652-4"><!-- content -->
     <p>Add New Event</p>
    </div>
    <div class="grpelem" id="u2513" style="text-align: center"><!-- custom html -->
        <form action="Event_AddEvent" method="post" style="float:center" onsubmit="return validate(this);">
            <input class="formtext" name="eventname" placeholder= "Event Name" type="text">
            <br><br>
            <input class="formtext" name="description" placeholder= "Desciption" type="text">
            <br><br>
            <input placeholder="Date" name="date" class="formtext" type="text" onfocus="(this.type='date')" onblur="(this.type='text')" id="date">
            <br><br>
            <select class="formmenu" name="type">
                <option value="mat1">Type 1</option>
                <option value="mat2">Type 2</option>
                <option value="mat3">Type 3</option>
                <option value="mat4">Type 4</option>
            </select>
            <br><br>
            <input class="formtext" name="estimatedbudget" placeholder= "Estimated Budget" type="number">
            <br><br>
            <input class="formtext" name="location" placeholder= "Location" type="text">
            <br><br>
