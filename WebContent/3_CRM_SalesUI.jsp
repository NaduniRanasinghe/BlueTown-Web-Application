 ...
 <body>
  ...
  <div class="museBGSize clearfix borderbox" id="page"><!-- group -->
     ...
     <div class="MenuItemContainer clearfix grpelem" id="u1469"><!-- vertical box -->
      ...
      <div class="SubMenu MenuLevel1 clearfix" id="u1470"><!-- vertical box -->
       <ul class="SubMenuView clearfix colelem" id="u1471"><!-- vertical box -->
        <li class="MenuItemContainer clearfix colelem" id="u1472"><!-- horizontal box --><div class="MenuItem MenuItemWithSubMenu rounded-corners clearfix grpelem" id="u1475"><!-- horizontal box --><div class="MenuItemLabel NoWrap clearfix grpelem" id="u1478-4"><!-- content --><div id="u1478-3"><p>Sign Out</p></div></div></div></li>
       </ul>
      </div>
     </div>
    </nav>
    <div class="clearfix" id="u1487-6"><!-- content -->
     <p id="u1487-2">Dereesha Vithanage</p>
     <p id="u1487-4">Sales Manager</p>
    </div>
   </div>
   <div class="clearfix grpelem" id="pu1447"><!-- group -->
    ...
    <a href="http://localhost:8080/Test1/cusreg.jsp"><button id="u1462"><p class="button-text">Customer Registration</p></button></a>
    <a href="http://localhost:8080/Test1/cusinp.jsp"><button id="u1460"><p class="button-text">Customer Information Portal</p></button></a>
    <div class="grpelem" id="u1459"><!-- content -->
     <div class="fluid_height_spacer"></div>
    </div>
   </div>
  </div>
  <!-- JS includes --><p>Customer Registration</p>
  <script type="text/javascript">
