...
<head>
    ...
    <title>Inventory Information Portal</title>
    <!-- CSS -->
    ...
    function myFunction() {
        ...
        table = document.getElementById("rawMat");
...
<div class="clearfix borderbox" id="page"><!-- group -->
    <div class="clearfix grpelem" id="pu133"><!-- group -->
        ...
        <div class="clearfix" id="u4013-6"><!-- content -->
            <p id="u4013-2">Roshan Gunananda</p>
            <p id="u4013-4">Inventory & Logistics Manager</p>
        </div>
    ...
    <div class="clearfix grpelem" id="pu1447"><!-- group -->
        ...
        <div class="para1 clearfix grpelem" id="u4039-4"><!-- content -->
            <p>Raw Material Information Portal</p>
        </div>
        <div class="grpelem" id="invent1"><!-- custom html -->
            <style type="text/css">
                .tg  {margin-left: -210px; leftborder-collapse:collapse;border-spacing:0;border-color:transparent;}
                .tg td{text-align: left; font-family:Arial, sans-serif;font-size:14px;padding:10px 13px;border-style:solid;border-width:1px;overflow:hidden;word-break:normal;border-top-width:1px;border-bottom-width:1px;border-color:#999;color:#444;background-color:#F7FDFA;}
            ...
            &nbsp; &nbsp; &nbsp; &nbsp;&nbsp; &nbsp; &nbsp; &nbsp;&nbsp;
            <input type="text" id="myInput" onkeyup="myFunction()" placeholder="Search by Name.." style = "height: 30px; width: 150px;border-radius: 15px" title="Type in material name">&nbsp; &nbsp;
            <input type = "submit" name="add" value="ADD MATERIALS" style = "background-color: gold; height: 30px; width: 150px;border-radius: 15px"
                 onclick="window.location.href='4_IL_raw_material_add.jsp'">
            <input type = "submit" name="email" value="SEND MAIL" style = "background-color: gold; height: 30px; width: 150px;border-radius: 15px"
                 onclick="window.location.href='4_IL_email.jsp'">     
            <br><br>
          
            <table class="tg" id="rawMat">
         
                <tr>
                    <th class="tg-ggay">ID&nbsp; &nbsp; &nbsp; &nbsp;</th>
                    <th class="tg-ggay">Material Name&nbsp; &nbsp; &nbsp; &nbsp;</th>
                    <th class="tg-ggay">Available Stock&nbsp; &nbsp; &nbsp; &nbsp;</th>
                    <th class="tg-ggay">Measurement Unit&nbsp; &nbsp; &nbsp; &nbsp;</th>
                    <th class="tg-ggay">Unit Price&nbsp; &nbsp; &nbsp; &nbsp;</th>
                    <th class="tg-ggay">Min. Quota&nbsp; &nbsp; &nbsp; &nbsp;</th>
                    <th class="tg-ggay">Total Expenses&nbsp; &nbsp; &nbsp; &nbsp;</th>
                ...
                <%
                     ...
                     String sql = "select * from bluelite.raw_material order by id;";
                ...
                %>
                     ...
                     <tr>
                         <td class="tg-fhq0"><%= rs.getInt("id") %></td>
                         <td class="tg-fhq0"><%= rs.getString("type") %></td>
                         <td class="tg-fhq0"><%= rs.getDouble("quantity") %></td>
                         <td class="tg-fhq0"><%= rs.getString("unit") %></td>
                         <td class="tg-fhq0"><%= rs.getDouble("unit_cost") %></td>
                         <td class="tg-fhq0"><%= rs.getDouble("quota") %></td>
                         <td class="tg-fhq0"><%= rs.getDouble("total") %></td>
                         <td><a href="4_IL_raw_material_update.jsp?update_id=<%=rs.getInt("id")%>">Update</a></td>
                         <td><a href="4_IL_raw_material_delete.jsp?delete_id=<%=rs.getInt("id")%>">Delete</a></td>
                     </tr>
