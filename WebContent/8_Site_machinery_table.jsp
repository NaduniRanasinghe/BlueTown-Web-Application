...
<head>
    ...
    <title>Machinery Information Portal</title>
    <!-- CSS -->
    ...
    function myFunction() {
     ...
     input = document.getElementById("machinery_input");
     filter = input.value.toUpperCase();
     table = document.getElementById("MachineryDet");
...
<div class="clearfix borderbox" id="page"><!-- group -->
    ...
    <div class="clearfix grpelem" id="pu1447"><!-- group -->
        ...
        <div class="para1 clearfix grpelem" id="u4039-4"><!-- content -->
            <p>Machinery Information Portal</p>
        </div>
        <div class="grpelem" id="invent1"><!-- custom html -->
            ...
            <div style="width:75%; " >
            	...
            	<input type = "submit" name="add" value="ADD MACHINERY" 
             		style = "margin:0px; padding:0px; background-color: #0b0470; color: white; height: 30px; width: 150px;border-radius: 15px; float:left" 
             		onclick="window.location.href='8_Site_machinery_add.jsp'">
             		
             		<input type = "submit" name="home" value="HOME" 
             		style = "margin:0px; padding:0px; background-color: #000; color: white; height: 30px; width: 50px;border-radius: 15px; float:center" 
             		onclick="window.location.href='8_Site_site-manager-profile.jsp'">
             		
           		<input type="text" id="machinery_input" style = "float:right; background-color: #fff; height: 30px; width: 475px; border-radius: 15px" onkeyup="myFunction()" placeholder="	search by machinery name" title="Type in site name">&nbsp; &nbsp;
				
				<br><br>
				<input type = "submit" name="cal" value="Calculate Quantity for Individual Machinery" 
             		style = "margin:0px; padding:2px; background-color: #0b0470; color: white; height: 30px; width:300px;border-radius: 15px; float:right" 
             		onclick="window.location.href='8_Site_calculator_2.jsp'">
            	<br><br>
            	<br><br>
            	
            <table class="tg" id="MachineryDet" style="border:1px solid black;background-color:transparent;">
                <tr>
                    <th style="border:1px solid black;" class="tg-ggay">ID&nbsp; &nbsp; &nbsp; &nbsp;</th>
                    <th style="border:1px solid black;" class="tg-ggay">Machinery Name&nbsp; &nbsp; &nbsp; &nbsp;</th>
                    <th style="border:1px solid black;" class="tg-ggay">Quantity&nbsp; &nbsp; &nbsp; &nbsp;</th>
                    <th style="border:1px solid black;" class="tg-ggay">Edit&nbsp; &nbsp; &nbsp; &nbsp;</th>
                    <th style="border:1px solid black;" class="tg-ggay">Delete</th>
                </tr>
                ...
                <%
                     ...
                     String sql = "select * from bluelite.machinery order by machineryID";
                ...
                %>
                     <tr style="border:1px solid blue;border-radius:3.5px">
                         <td style="border:1px solid blue;border-radius:3.5px" class="tg-fhq0"><%= rs.getInt("machineryID") %></td>
                         <td style="border:1px solid blue;border-radius:3.5px" class="tg-fhq0"><%= rs.getString("machineryName") %></td>
                         <td style="border:1px solid blue;border-radius:3.5px" class="tg-fhq0"><%= rs.getDouble("quantity") %></td>
                         <td style="border:1px solid blue;border-radius:3.5px;background-color: #AAFFF9;"><a href="8_Site_machinery_update.jsp?update_id=<%=rs.getInt("machineryID")%>">Update</a></td>
                         <td style="border:1px solid blue;border-radius:3.5px;background-color: #AAFFF9;"><a href="8_Site_machinery_delete.jsp?delete_id=<%=rs.getInt("machineryID")%>">Delete</a></td>
                     </tr>
