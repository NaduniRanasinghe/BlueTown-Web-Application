  ...
  <div class="museBGSize clearfix borderbox" id="page"><!-- group -->
   ...
   <div class="clearfix grpelem" id="pu1447"><!-- group -->
    ...
    <div class="grpelem" id="u2513" style="text-align: center"><!-- custom html -->
        <form action="Finance_AddPurchaseEntryController" method="post">
            <input class="formtext" name="invoiceNumber" placeholder= "Invoice Number" type="number">
            <br><br>
            <input placeholder="Date" class="formtext" name= "date" type="text" onfocus="(this.type='date')" onblur="(this.type='text')" >
            <br><br>
            <input class="formtext" name="sellerID" placeholder="Seller ID" type="number">
            <br><br>
            <input class="formtext" name="additional" placeholder="Additional Details" type="text">
            <br><br>
            <input class="formtext" name="value" placeholder= "Value" type="number" min="0" step="0.01">
            <br><br>
            <input class="formbutton" type="submit"  name="addEntryBtn"><br><br>
            <a href="2_finance_purchase-information-portal.jsp"><input class="formbutton" type="button"  name="btn_back" value="Cancel"></a>
        </form>
