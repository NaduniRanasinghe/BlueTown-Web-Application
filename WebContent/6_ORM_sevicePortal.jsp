...
<head>
    ...
    <title>Supplier Information Portal</title>
    <!-- CSS -->
...
<div class="clearfix borderbox" id="page"><!-- group -->
    <div class="clearfix grpelem" id="pu133"><!-- group -->
        ...
        <div class="clearfix" id="u4013-6"><!-- content -->
            <p id="u4013-2">Nilmini Mannapperuma</p>
            <p id="u4013-4">OR Manager</p>
        </div>
    ...
    <div class="clearfix grpelem" id="pu1447"><!-- group -->
        ...
        <div class="para1 clearfix grpelem" id="u4039-4"><!-- content -->
            <p>Service Provider Information Portal</p>
        </div>
        <div class="grpelem" id="u4035"><!-- custom html -->
      
            <style type="text/css">
                .tg  {border-collapse:collapse;border-spacing:0;border-color:transparent;}
                .tg td{font-family:Arial, sans-serif;font-size:14px;padding:10px 13px;border-style:solid;border-width:0px;overflow:hidden;word-break:normal;border-top-width:1px;border-bottom-width:1px;border-color:#999;color:#444;background-color:#F7FDFA;}
...
<table>
					<tr>
						...
						<td  style="padding: 10px">
							<a href="service.jsp"><button>Add New Record</button></a>
						</td>
					</tr>
				</table>
				<br><br>
                ...
                <tr>
                    ...
                    <th class="tg-ggay">Address</th>
                    <th class="tg-ggay">City</th>                                       
                    <th class="tg-ggay">Email</th>
                     <th class="tg-ggay">Mobile</th>
...
if(query !=null){
	 ...
	 sql ="select * from blueLite.serviceportal where name like '%"+query+"%' or id like'%"+query+"%' "
			 
			 ;
}else{

sql ="select * from blueLite.serviceportal";
...
%>
                  ...
                  <tr>
                    ...
                    <td class="tg-fhq0"><%=rs.getString("name")%></td>                                                                            
                   <td class="tg-fhq0"><%=rs.getString("address_line_1")%></td>
                    <td class="tg-fhq0"><%=rs.getString("address_line_2")%></td>
                    <td class="tg-fhq0"><%=rs.getString("city")%></td>                 
                   <td class="tg-fhq0"><%=rs.getString("email")%></td>
                  <td class="tg-fhq0"><%=rs.getString("mobile")%></td>
                    
                    <td class="tg-fhq0"><a href="6_ORM_EditService.jsp?edit_id=<%=rs.getInt("id")%>">Edit</a></td>
                  <td class="tg-fhq0"><a href="6_ORM_servicesupplierDelete.jsp?delete_id=<%=rs.getInt("id")%>">Delete</a></td>
