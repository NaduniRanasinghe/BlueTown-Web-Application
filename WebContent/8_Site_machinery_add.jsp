  ...
  <![endif]-->
	...
	<script type="text/javascript"> 
     ...
     <script type="text/javascript">
     	...
     	function demo(){
     		document.getElementById("machineryName").value="Bulldozers";
  ...
  <div class="museBGSize clearfix borderbox" id="page"><!-- group -->
   ...
   <div class="clearfix grpelem" id="pu1447"><!-- group -->
    ...
    <div class="grpelem" id="u2513" style="text-align: center"><!-- custom html -->
        ...
        <form method="POST" action="Site_MachineryAddController" style="float:center" onsubmit="return validate(this);">
        
        
            <select class="formtext" id="machineryName" name="machineryName" required="required" style="width:200px">
            	...
            	<option value="Automatic Brick Maker">Automatic Brick Maker</option>
