...
if(typeof Muse == "undefined") window.Muse = {}; window.Muse.assets = {"required":["museutils.js", "museconfig.js", "jquery.musepolyfill.bgsize.js", "jquery.musemenu.js", "jquery.watch.js", "webpro.js", "musewpdisclosure.js", "require.js", "employee-registration.css"], "outOfDate":[]};
  ...
  <link rel="stylesheet" type="text/css" href="css/salary-form.css?crc=126118698" id="pagesheet"/>
  <!-- IE-only CSS -->
  <!--[if lt IE 9]>
  ...
  <![endif]-->
	...
	<script>
	     function validate(form){
	    	 ...
	    	 if(form.nic.value == ""){
	    		 error.push("Error: NIC field cannot be kept null");
	    	 }
	    	 else if(!nic.test(form.nic.value)){
	    		 error.push("Error: Invalid input");
	    	 }
	    	 if(form.basicsal.value == ""){
	    		 error.push("Error: Basic Salary field cannot be kept null");
	    	 }
	    	 else if(!salary.test(form.basicsal.value)){
	    		 error.push("Error: Invalid input");
	    	 }
	    	 if(form.decrement.value == ""){
	    		 error.push("Error: Decrement field cannot be kept null");
	    	 }
	    	 else if(!salary.test(form.decrement.value)){
	    		 error.push("Error: Invalid input");
	    	 }
	    	 if(form.othours.value == ""){
	    		 error.push("Error: OT Hours field cannot be kept null");
	    	 }
	    	 else if(!salary.test(form.othours.value)){
	    		 error.push("Error: Invalid input");
	    	 }
	    	 if(form.otrate.value == ""){
	    		 error.push("Error: OT rate field cannot be kept null");
	    	 }
	    	 else if(!salary.test(form.otrate.value)){
	    		 error.push("Error: Invalid input");
	    	 }
	    	 if(form.bonus.value == ""){
	    		 error.push("Error: Bonus field cannot be kept null");
	    	 }
	    	 else if(!salary.test(form.bonus.value)){
	    		 error.push("Error: Invalid input");
	    	 }
	    	 if(form.commission.value == ""){
	    		 error.push("Error: Commision field cannot be kept null");
	    	 }
	    	 else if(!salary.test(form.commission.value)){
	    		 error.push("Error: Invalid input");
	    	 }
  ...
  <div class="museBGSize clearfix borderbox" id="page"><!-- group -->
   ...
   <div class="clearfix grpelem" id="pu1447"><!-- group -->
    ...
    <div class="grpelem" id="u3128" style="text-align: center"><!-- custom html -->
        <form action="HR_AddSalary" method ="post" style="float:center" onsubmit="validate(this);">
              <input class="formtext" name="nic" placeholder= "Employee NIC" type="text">
              <br><br>
              <input class="formtext" name="basicsal" placeholder= "Basic Salary" type="number">
              <br><br>
              <input class="formtext" name="decrement" placeholder= "Decrements" type="number">
              <br><br>
              <input class="formtext" name="othours" placeholder= "Over-Time Hours" type="number">
              <br><br>
              <input class="formtext" name="otrate" placeholder= "Over-Time Rate" type="number">
              <br><br>
              <input class="formtext" name="bonus" placeholder= "Bonus" type="number">
              <br><br>
              <input class="formtext" name="commission" placeholder= "Commission" type="number">
              <br><br>
