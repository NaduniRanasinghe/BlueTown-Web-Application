...
if(typeof Muse == "undefined") window.Muse = {}; window.Muse.assets = {"required":["museutils.js", "museconfig.js", "jquery.musepolyfill.bgsize.js", "jquery.musemenu.js", "jquery.watch.js", "webpro.js", "musewpdisclosure.js", "require.js", "add-apartment.css"], "outOfDate":[]};
</script>
  
 <script>
function validateForm() {
    var x = document.forms["myForm"]["apartmentname"].value;
    var y= document.forms["myForm"]["apartment_id"].value;
    var z= document.forms["myForm"]["squreft"].value;
  ...
  /*  if(isAlphebatic(x))
    ...
    */
    ...
    if (x == "") {
     ...
     if (!apartmentname.value.match(alpha)) {
        alert('Apartment name should be include letters');       
        return false;
     ...
     if (y =="" ) {
         alert("Every feild must filled out");
         return false;
     }
     
     if (isNaN(y) || x < 1 || x > 10) {
       alert("Inputs are not valid..Apartment ID and Square feet should be numeric");
       return false;
   }
...
function isAlphebatic(elemValue){
    var exp=/^[a-zA-Z]+$/;
    if(!isEmpty(elemValue,"apartmentname")){
        if(elemValue.match(exp)){
            return true;
        }
        else{
            alert("Enter only text for your Apartment Name");
            return false;
        }
    }
    else{
...
function isNumeric(elemValue){
    if(!isEmpty(elemValue,"Square feet")) {
        var exp = /^[0-9]+$/;
  ...
  <link rel="stylesheet" type="text/css" href="css/add-apartment.css?crc=3927634919" id="pagesheet"/>
  <!-- IE-only CSS -->
  <!--[if lt IE 9]>
  <link rel="stylesheet" type="text/css" href="css/iefonts_add-apartment.css?crc=304733005"/>
  <![endif]-->
  <!-- Other scripts -->
  <script type="text/javascript">
 ...
 <body>
  <div class="museBGSize clearfix borderbox" id="page"><!-- group -->
   <div class="clearfix grpelem" id="pu133"><!-- group -->
    ...
    <nav class="MenuBar clearfix" id="menuu3695"><!-- horizontal box -->
     <div class="MenuItemContainer clearfix grpelem" id="u3696"><!-- vertical box -->
      <div class="MenuItem MenuItemWithSubMenu borderbox museBGSize clearfix colelem" id="u3697"><!-- horizontal box -->
       <div class="MenuItemLabel NoWrap clearfix grpelem" id="u3699-3"><!-- content -->
        <p>&nbsp;</p>
       </div>
      </div>
      <div class="SubMenu MenuLevel1 clearfix" id="u3701"><!-- vertical box -->
       <ul class="SubMenuView clearfix colelem" id="u3702"><!-- vertical box -->
        <li class="MenuItemContainer clearfix colelem" id="u3703"><!-- horizontal box --><div class="MenuItem MenuItemWithSubMenu rounded-corners clearfix grpelem" id="u3706"><!-- horizontal box --><div class="MenuItemLabel NoWrap clearfix grpelem" id="u3707-4"><!-- content --><div id="u3707-3"><p>Sign Out</p></div></div></div></li>
       </ul>
      </div>
     </div>
    </nav>
    <div class="clearfix" id="u3710-6"><!-- content -->
     <p id="u3710-2">Dereesha Vithanage</p>
     <p id="u3710-4">Sales Manager</p>
    </div>
   </div>
   <div class="clearfix grpelem" id="pu1447"><!-- group -->
    ...
    <div class="grpelem" id="u3667"><!-- simple frame --></div>
    <div class="para1 clearfix grpelem" id="u3665-4"><!-- content -->
     <p>Update Additional Features </p>
    </div>
    <div class="grpelem" id="u3666" style="text-align: center"><!-- custom html -->
        <form  name="myForm" action="Sales_EditFeatures" method="post" onsubmit="return validateForm()" style="float:center;" >
           ...
           <%
            if(request.getParameter("edit_id")!=null) 
            {
                ...
                try
                {
                    ...
                    pstmt=connection.prepareStatement("select * from bluelite.features where id=?"); 
                    pstmt.setInt(1,id);
            ...
            <p><font color="red">Enter ApartmentID, that you previously entered..?</font></p>
             <input class="formtext" name="apartment_id" value="<%=rs.getInt("apartmentId")%>" type="text">
            <br><br>
            <p><font color="red">Do you need A/C..?</font></p>
          	 <select class="formmenu" name="room">
                <option value="AC">AC</option>
                <option value="Non-AC">Non-AC</option>
            </select>
            <br><br>
            <p><font color="red">Do you need Attached-Bathroom..?</font></p>
            <select class="formmenu" name="Attached-Bathroom">
                <option value="Yes">Yes</option>
                <option value="No">No</option>
            </select>
            <br><br>
            <p><font color="red">Do you need CCTV cameras..?</font></p>
            <select class="formmenu" name="CCTV">
                <option value="Yes">Yes</option>
                <option value="No">No</option>
            </select>
            <br><br>
            <p><font color="red">Do you need a ServentRoom..?</font></p>
            <select class="formmenu" name="serventRoom">
                <option value="Yes">Yes</option>
                <option value="No">No</option>
            </select>
            <br><br>
             <input type="hidden" name="hidden_id" value="<%=rs.getInt("id")%>">
            <input class="formbutton" name= "btn_edit" type="submit" onclick="validateFormNew()" >
