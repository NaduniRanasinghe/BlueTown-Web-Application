...
if(typeof Muse == "undefined") window.Muse = {}; window.Muse.assets = {"required":["museutils.js", "museconfig.js", "jquery.musepolyfill.bgsize.js", "jquery.musemenu.js", "jquery.watch.js", "webpro.js", "musewpdisclosure.js", "require.js", "new-finance-entry.css"], "outOfDate":[]};
  ...
  <title>Monthly Revenue Entry</title>
  <!-- CSS -->
 ...
 <body>
  ...
  <div class="museBGSize clearfix borderbox" id="page"><!-- group -->
   <div class="clearfix grpelem" id="pu133"><!-- group -->
    ...
    <a href="finance-manager-profile.jsp">
    ...
    <div class="clearfix" id="u3499-6"><!-- content -->
     <p id="u3499-2">Dushan Hemantha</p>
     <p id="u3499-4">Finance Manager</p>
    </div>
   </div>
   <div class="clearfix grpelem" id="pu1447"><!-- group -->
    ...
    <div class="grpelem" id="u1649"><!-- simple frame --></div>
    <div class="para1 clearfix grpelem" id="u1652-4"><!-- content -->
     <p>Monthly Revenue Entry</p>
    </div>
    <div class="grpelem" id="u2513" style="text-align: center"><!-- custom html -->
        <form action="Finance_AddFinanceEntryController" method="post" name="vform" onsubmit="return Validate()">
        	<p id="year_error" class="error_text"></p>
            <input id="year_textbox" class="formtext" name="year" placeholder= "Year" type="number">
            <br><br>
            <p id="month_error" class="error_text"></p>
            <select id="month_textbox"class="formmenu" name="month" >
            ...
            <br><br>
            <input id="review_textbox" class="formtext" name="review" placeholder= "Review (optional)" type="text">
            <br><br>
            <p id="revenue_error" class="error_text"></p>
            <input id="revenue_textbox" class="formtext" name="revenue" placeholder= "Monthly Revenue" type="number">
            <br><br>
            <input class="formbutton" type="submit"  name="btn_add"><br><br>
            <a href="2_finance_revenue-information-portal.jsp"><input class="formbutton" type="button"  name="btn_back" value="Cancel"></a>
            <br><br>
            <input class="formbutton" type="button"  name="demo-button" value="Demo" onclick="demo()">
        </form>
...
<script type="text/javascript">
	...
	var year = document.forms["vform"]["year"];
	var revenue = document.forms["vform"]["revenue"];
	var month = document.forms["vform"]["month"];
	
	//Getting the error displaying object
	var year_error = document.getElementById("year_error");
	var revenue_error = document.getElementById("revenue_error");
	var month_error = document.getElementById("month_error");
	var black_box = document.getElementById("u1649");
	
	//Setting the event listners
	year.addEventListener("blur", yearVerify, true);
	revenue.addEventListener("blur", revenueVerify, true);
	month.addEventListener("blur", monthVerify, true);
	
	//validation function
	function Validate() {
		if (year.value == "") {
			year.style.border = "2px solid #962e2e";
			black_box.style.height = "470px";
			year_error.textContent = "*Year is required.";
			year.focus();
			return false;
		}
		
		if (year.value < 2018 || year.value > 3000) {
			year.style.border = "2px solid #962e2e";
			black_box.style.height = "470px";
			year_error.textContent = "*Invalid input.";
			year.focus();
			return false;
		}
		
		if (revenue.value == "") {
			revenue.style.border = "2px solid #962e2e";
			black_box.style.height = "470px";
			revenue_error.textContent = "*Revenue is required.";
			revenue.focus();
			return false;
		}
		
		if (month.value == "") {
			month.style.border = "2px solid #962e2e";
			black_box.style.height = "470px";
			month_error.textContent = "*Month is required.";
			month.focus();
			return false;
		}
		
		if (revenue.value < 0.01 || revenue.value > 999999999.99) {
			revenue.style.border = "2px solid #962e2e";
			black_box.style.height = "470px";
			revenue_error.textContent = "*Invalid input.";
			revenue.focus();
			return false;
		}
	}
	...
	function yearVerify(){
		if (year.value != "") {
			year.style.border = "0px none";
			year_error.innerHTML = "";
			return true;
		}
	}
	
	function revenueVerify(){
		if (revenue.value != "") {
			revenue.style.border = "0px none";
...
<script>
	// demo function
	function demo() {
		document.getElementById("year_textbox").value = "2019";
		document.getElementById("month_textbox").value = "January";
		document.getElementById("review_textbox").value = "Demonstration";
		document.getElementById("revenue_textbox").value = "1000.00";
