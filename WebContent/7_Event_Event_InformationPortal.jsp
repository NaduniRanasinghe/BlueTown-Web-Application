...
<head>
    ...
    <title>Event Information Portal</title>
    <!-- CSS -->
...
<div class="clearfix borderbox" id="page"><!-- group -->
    <div class="clearfix grpelem" id="pu133"><!-- group -->
        ...
        <div class="clearfix" id="u4013-6"><!-- content -->
            <p id="u4013-2">Nalaka Jayawardene</p>
            <p id="u4013-4">Marketing Manager</p>
        </div>
...
%> 
                ...
                <tr>
                    ...
                    <th class="tg-ggay">Event Name</th>
                    <th class="tg-ggay">Date</th>
                    <th class="tg-ggay">description</th>
                    <th class="tg-ggay">EventType</th>
                    <th class="tg-ggay">estimateBudget</th>
                    <th class="tg-ggay">location</th>
...
if(query !=null){
	 ...
	 sql ="select * from bluelite.event where eventname like '%"+query+"%' or Description like'%"+query+"%' or location like'%"+query+"%'" ;
}else{

sql ="select * from blueLite.event";
...
%>
                ...
                <tr>
                	<td class="tg-i0kf"><%=rs.getString("id")%></td>
                    <td class="tg-i0kf"><%=rs.getString("eventname")%></td>
                   <td class="tg-i0kf"><%=rs.getString("date")%></td>
                     <td class="tg-i0kf"><%=rs.getString("description")%></td>
                    <td class="tg-i0kf"><%=rs.getString("EventType")%></td>
                    <td class="tg-i0kf"><%=rs.getDouble("estimateBudget")%></td>
                    <td class="tg-i0kf"><%=rs.getString("location")%></td>
                   
                   
                    
                    <td class="tg-i0kf"><a href="7_Event_event_edit.jsp?edit_id=<%=rs.getInt("id")%>">Edit</a></td>
                    <td class="tg-i0kf"><a href="7_Event_event_delete.jsp?delete_id=<%=rs.getInt("id")%>">Delete</a></td>
