...
<head>
    ...
    <title>Purchase Information Portal</title>
    <!-- CSS -->
...
<div class="clearfix borderbox" id="page"><!-- group -->
    ...
    <div class="clearfix grpelem" id="pu1447"><!-- group -->
        ...
        <div class="para1 clearfix grpelem" id="u4039-4"><!-- content -->
            <p>Purchase Information Portal</p>
        </div>
        <div class="grpelem" id="invent1"><!-- custom html -->
            <style type="text/css">
                ...
                .tg td{text-align: left; font-family:Arial, sans-serif;font-size:14px;padding:10px 13px;border-style:solid;border-width:0px;overflow:hidden;word-break:normal;border-top-width:1px;border-bottom-width:1px;border-color:#999;color:#000000;background-color:#F7FDFA; opacity:0.5}
				...
				<table>
					<tr>
						...
						<td  style="padding: 10px">
							<a href="purchase-entry.jsp"><button>Add New Record</button></a>
						</td>
					</tr>
				</table>
				<br><br>
				...
				<table class="tg">
                <tr>
                    <th class="tg-ggay">Invoice Number</th>
                    <th class="tg-ggay">Date</th>
                    <th class="tg-ggay">Seller ID</th>
                    <th class="tg-ggay">Additional Details</th>
                    <th class="tg-ggay">Value</th>
				...
				<%
					try{ 
						...
						String sql;
						if(query !=null){
							sql ="select * from bluelite.purchase where InvoiceNumber like '%"+query+"%' or SellerID like'%"+query+"%' or Date like'%"+query+"%'";
						}
						else{
						sql ="select * from bluelite.purchase";
					}
				...
				%>
			  <tr>
                    <td><%=rs.getInt("InvoiceNumber")%></td>
                    <td><%=rs.getString("Date")%></td>
                    <td><%=rs.getInt("SellerID")%></td>
                    <td><%=rs.getString("AdditionalDetails")%></td>
                    <td><%=rs.getDouble("Value") %>0</td>
                 
                    
                    <td><a class="linkstyle" href="2_finance_purchase-edit.jsp?edit_id=<%=rs.getInt("InvoiceNumber")%>">Edit</a></td>
                    <td><a href="2_finance_purchase-delete.jsp?delete_id=<%=rs.getInt("InvoiceNumber")%>">Delete</a></td>
