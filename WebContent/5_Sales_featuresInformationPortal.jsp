...
%> 
                ...
                <tr>
                    ...
                    <th class="tg-ggay">AC</th>
                    <th class="tg-ggay">Attached Bathroom</th>
                    <th class="tg-ggay">CCTV</th>
                    <th class="tg-ggay">serventRoom</th>
...
if(query !=null){
	 ...
	 sql ="select * from bluelite.features where id like '%"+query+"%' or apartmentId like'%"+query+"%' or type like'%"+query+"%'";
}else{

sql ="select * from blueLite.features";
...
%>
             ...
             <tr>
                   ...
                   <td class="tg-i0kf"><%=rs.getString("AC")%></td>
                    <td class="tg-i0kf"><%=rs.getString("AttachedBathroom")%></td>
                    <td class="tg-i0kf"><%=rs.getString("CCTV")%></td>
                    <td class="tg-i0kf"><%=rs.getString("serventRoom")%></td>
                    
                   
                    
                    <td class="tg-i0kf"><a href="5_Sales_EditFeatures.jsp?edit_id=<%=rs.getInt("id")%>">Edit</a></td>
                    <td class="tg-i0kf"><a href="5_Sales_deleteFeatures.jsp?delete_id=<%=rs.getInt("id")%>">Delete</a></td>
