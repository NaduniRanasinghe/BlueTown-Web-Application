  ...
  <div class="museBGSize clearfix borderbox" id="page"><!-- group -->
   ...
   <div class="clearfix grpelem" id="pu1447"><!-- group -->
    ...
    <div class="grpelem" id="u3666" style="text-align: center"><!-- custom html -->
        <form  name="myForm" action="Sales_AddApartment" method="post" onsubmit="return validateForm()" style="float:center;" >
            <input class="formtext" name="apartmentname" id="apartmentname" placeholder= "Name" type="text">
            <br><br>
            <input class="formtext" name="apartment_id" id="apartment_id" placeholder= "ID" type="text">
            <br><br>
            ...
            <br><br>
            <input class="formtext" name="squreft" placeholder= "Square Feet" id="Square Feet" type="text">
            <br><br>
            <input class="formbutton" name= "btn_add" type="submit" onclick="validateForm()">
        </form>
