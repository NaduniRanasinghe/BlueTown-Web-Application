...
<table>
					<tr>
						...
						<td  style="padding: 10px">
							<a href="1_HR_recruitment-entry.jsp"><button>Add New Record</button></a>
						</td>
						<td  style="padding: 10px">
							<a href="1_HR_Applicants.jsp"><button>Applicants</button></a>
						</td>
...
%> 
                ...
                <tr>
                    ...
                    <th class="tg-ggay">Position</th>
                   
                   
                    <th class="tg-ggay">Expiry Date</th>
                     <th class="tg-ggay">Status</th>
                    <th class="tg-ggay">Supervisor</th>
                ...
                <tr>
                   ...
                   <td ><%=rs.getString("department")%></td>
                    ...
                    <td><%=rs.getString("exdate")%></td>
                     <td ><%=rs.getString("empStatus")%></td>
                     <td ><%=rs.getString("supervisor")%></td>
                 
                   
                    
                    <td class="tg-i0kf"><a href="1_HR_EditRecruitment.jsp?edit_id=<%=rs.getInt("id")%>">Edit</a></td>
                    <td class="tg-i0kf"> <a href="1_HR_DeleteRecruitment.jsp?delete_id=<%=rs.getInt("id")%>">Delete</a></td>
