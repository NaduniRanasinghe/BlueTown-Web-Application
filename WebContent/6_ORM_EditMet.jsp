        ...
        <%
            if(request.getParameter("edit_id")!=null) 
            {
                ...
                try
                {
                    ...
                    {
            %>
              <input class="formtext" name=" Name" value="<%=rs.getString("company_name")%>" type="text">
              <br><br>
            ...
            <br><br>
            <input class="formtext" name="itemname" value="<%=rs.getString("item_name")%>" type="text">
            <br><br>
             <input class="formtext" name="unitprice" value="<%=rs.getDouble("unit_price")%>" type="text">
            <br><br>
            <br>
