...
if(typeof Muse == "undefined") window.Muse = {}; window.Muse.assets = {"required":["museutils.js", "museconfig.js", "jquery.musepolyfill.bgsize.js", "jquery.musemenu.js", "jquery.watch.js", "webpro.js", "musewpdisclosure.js", "require.js", "new-finance-entry.css"], "outOfDate":[]};
  ...
  <link rel="stylesheet" type="text/css" href="css/new-bill-entry.css?crc=3904585476" id="pagesheet"/>
  <!-- IE-only CSS -->
  <!--[if lt IE 9]>
   ...
   <div class="clearfix grpelem" id="pu1447"><!-- group -->
    <div class="browser_width grpelem" id="u1447-bw">
     <div class="size_browser_width" id="u1447"><!-- custom html -->
			...
			<a href="bill-information-portal.jsp"><button id= "navigation">Back</button></a>
    ...
    <div class="para1 clearfix grpelem" id="u1652-4"><!-- content -->
     <p>Edit Bill Record</p>
    </div>
    <div class="grpelem" id="u2513" style="text-align: center"><!-- custom html -->
        <form action="Finance_EditBillEntryController" method="post">
        <% 
        if(request.getParameter("edit_id")!=null)
        {
           ...
           try
           {
        	   ...
        	   pstmt = conn.prepareStatement("select * from bluelite.bill where BillNumber=?");
        	   pstmt.setInt(1,id);
        	   ...
        	   {     	
        %>
        	<input class="formtext" type="number" placeholder= "Bill Number" name="billNumber" value="<%=rs.getInt("BillNumber")%>">
        	<br><br>
            <select class="formmenu" name="type">
            	<option value="<%=rs.getString("Type") %>" selected disabled hidden><b><%=rs.getString("Type") %></b></option>
			...
			<br><br>
            <input placeholder="Bill Date" class="formtext" name= "billDate" type="text" onfocus="(this.type='date')" onblur="(this.type='text')" value="<%=rs.getString("BillDate") %>">
            <br><br>
            <input placeholder="Due Date" class="formtext" name= "dueDate" type="text" onfocus="(this.type='date')" onblur="(this.type='text')" value="<%=rs.getString("DueDate") %>">
            <br><br>
            <input class="formtext" name="additional" placeholder="Additional Details" type="text" value="<%=rs.getString("AdditionalDetails") %>">
            <br><br>
            <input class="formtext" name="payment" placeholder= "Total Payment" type="number" min="0" step="0.01" value="<%=rs.getDouble("Payment") %>">
            <br><br>
            <input class="formbutton" type="submit"  name="edit" Value="Confirm">
            <br><br><a href="revenue-information-portal.jsp"><input class="formbutton" type="button"  name="btn_back" value="Cancel"></a>
            <input type="hidden" name="hidden_id" value="<%=rs.getInt("BillNumber")%>">
