...
<head>
    ...
    <title>Revenue Information Portal</title>
    <!-- CSS -->
    ...
    <link rel="stylesheet" type="text/css" href="css/new-revenue-information-portal.css?crc=270216157" id="pagesheet"/>
...
<div class="clearfix borderbox" id="page"><!-- group -->
    <div class="clearfix grpelem" id="pu133"><!-- group -->
        ...
        <div class="clearfix" id="u4013-6"><!-- content -->
            <p id="u4013-2">Dushan Hemantha</p>
            <p id="u4013-4">Finance Manager</p>
        </div>
        <nav class="MenuBar clearfix" id="menuu4014"><!-- horizontal box -->
            <div class="MenuItemContainer clearfix grpelem" id="u4015"><!-- vertical box -->
                <a href="finance-manager-profile.jsp"><div class="MenuItem MenuItemWithSubMenu borderbox museBGSize clearfix colelem" id="u4016"></a><!-- horizontal box -->
                ...
                <div class="SubMenu MenuLevel1 clearfix" id="u4020"><!-- vertical box -->
                    <ul class="SubMenuView clearfix colelem" id="u4021"><!-- vertical box -->
                        <a href="finance-manager-profile.jsp"><li class="MenuItemContainer clearfix colelem" id="u4022"><!-- horizontal box --><div class="MenuItem MenuItemWithSubMenu rounded-corners clearfix grpelem" id="u4025"><!-- horizontal box --><div class="MenuItemLabel NoWrap clearfix grpelem" id="u4026-4"><!-- content --><div id="u4026-3"><p>Profile</p></div></div></div></li></a>
    ...
    <div class="clearfix grpelem" id="pu1447"><!-- group -->
        <div class="browser_width grpelem" id="u1447-bw">
            <div class="size_browser_width" id="u1447"><!-- custom html -->
				...
				<a href="finance-manager-profile.jsp"><button id= "navigation">Back</button></a>
        ...
        <div class="para1 clearfix grpelem" id="u4039-4"><!-- content -->
            <p>Revenue Information Portal</p>
        </div>
            ...
            <style type="text/css">
            	.searchbar {margin-left: 0; border-collapse:collapse;border-spacing:0;border-color:transparent;}
                .tg  {width:200px; margin-left: 200px; border-collapse:collapse;border-spacing:0;border-color:transparent;}
                .tg td{text-align: center; font-family:Arial, sans-serif;font-size:14px;padding:10px 13px;border-style:solid;border-width:0px;overflow:hidden;word-break:normal;border-top-width:1px;border-bottom-width:1px;border-color:#999;color:#444;background-color:#F7FDFA;opacity:0.5;}
				...
				<table class="searchbar">
					<tr>
						<td style="padding: 10px">
							<a href="finance-manager-profile.jsp"><button>Back</button></a>
						</td>
						...
						<td style="padding: 10px">
							<a href="revenue-entry.jsp"><button>Add New Record</button></a>
						</td>
						<td style="padding: 10px">
							<a href="FinanceEntryReport"><button>Generate Report</button></a>
						</td>
					</tr>
				</table>
				<br><br>
                ...
                <tr>
                    ...
                    <th class="tg-ggay">Year</th>
                    <th class="tg-ggay">Month</th>
                    <th class="tg-ggay">Review</th>
                    <th class="tg-ggay">Revenue</th>
				...
				<%
					try{ 
						...
						String sql;
						if(query !=null){
							sql ="select * from bluelite.revenue where Year like '%"+query+"%' or Month like'%"+query+"%' ";
						}
						else{
						sql ="select * from bluelite.revenue";
					}
			  ...
			  <tr>
                    ...
                    <td><a href="2_finance_revenue-edit.jsp?edit_id=<%=rs.getInt("ID")%>">Edit</a></td>
                    <td><a href="2_finance_revenue-delete.jsp?delete_id=<%=rs.getInt("ID")%>">Delete</a></td>
