  ...
  <div class="museBGSize clearfix borderbox" id="page"><!-- group -->
   ...
   <div class="clearfix grpelem" id="pu1447"><!-- group -->
    ...
    <div class="grpelem" id="u3666" style="text-align: center"><!-- custom html -->
        <form  name="myForm" action="Sales_EditApartment" method="post" onsubmit="return validateForm()" style="float:center;" >
           ...
           <%
            if(request.getParameter("edit_id")!=null) 
            {
                ...
                try
                {
                    ...
                    pstmt=connection.prepareStatement("select * from bluelite.apartment where id=?"); 
                    pstmt.setInt(1,id);
            ...
            <input class="formtext" name="apartmentname" id="apartmentname" value="<%=rs.getString("apartmentName")%>" type="text">
            <br><br>
            <input class="formtext" name="apartment_id" id="apartment_id" value="<%=rs.getInt("apartmentId")%>" type="text">
            <br><br>
            ...
            <br><br>
            <select class="formmenu" name="number">
            ...
            <br><br>
            <input class="formtext" name="squreft" value="<%=rs.getDouble("squrft")%>" id="Square Feet" type="text">
            <br><br>
            <input class="formbutton" name= "btn_edit" type="submit"  onclick="validateForm()">
