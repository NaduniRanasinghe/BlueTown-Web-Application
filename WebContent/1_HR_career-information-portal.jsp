...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="css/revenue-information-portal.css?crc=270216157" id="pagesheet"/>
...
<div class="clearfix borderbox" id="page"><!-- group -->
    ...
    <div class="clearfix grpelem" id="pu1447"><!-- group -->
        ...
        <div class="para1 clearfix grpelem" id="u4039-4"><!-- content -->
            <p>Careers at Bluetown Company</p>
        </div>
            ...
            <style type="text/css">
                .tg  {width:500px; margin-left: 100px; border-collapse:collapse;border-spacing:0;border-color:transparent;}
                .tg td{text-align: justify; font-family:Lato Light;font-size:14px;padding:10px 13px;border-style:solid;border-width:0px;overflow:hidden;word-break:normal;border-top-width:0px;border-bottom-width:0px;border-color:#999;color:#ffffff;background-color:#000000; opacity: 0.5;}
                .tg th{font-family:Arial, sans-serif;font-size:14px;font-weight:normal;padding:5px;border-style:none;border-width:0px;overflow:hidden;word-break:normal;border-top-width:0;border-bottom-width:0px;border-color:transparent;color:#fff;background-color:#26ADE4;}
...
if(query !=null){
	 ...
	 sql ="select * from bluelite.career where department like '%"+query+"%' or supervisor like'%"+query+"%' or empStatus like'%"+query+"%'";
}else{

sql ="select * from blueLite.career";
...
%>
	...
	<tr>
	<th class="tg-ggay"><p id="jobtitle"><%=rs.getString("post")%></p></th>
	<th class="tg-ggay thead" rowspan="2"><a href="1_HR_UploadCV.jsp"><button class="applybutton">Apply</button></a></th>	
</tr>
<tr>
	<th class="tg-ggay"><p id="status"><%=rs.getString("empStatus")%></p></th>
</tr>
<tr>
	<td colspan="2">
	<br>
	<p id="JD">Job Description:</p><br>
	<%=rs.getString("jobdDescription")%>
	</td>	
</tr>
</table>
