...
<head>
    ...
    <title>Material Information Portal</title>
    <!-- CSS -->
    ...
    function myFunction() {
     ...
     table = document.getElementById("MaterialDet");
...
<div class="clearfix borderbox" id="page"><!-- group -->
    ...
    <div class="clearfix grpelem" id="pu1447"><!-- group -->
        ...
        <div class="para1 clearfix grpelem" id="u4039-4"><!-- content -->
            <p>Material Information Portal</p>
        </div>
        <div class="grpelem" id="invent1"><!-- custom html -->
            ...
            <div style="width:75%; " >
            	...
            	<input type = "submit" name="add" value="ADD MATERIAL" 
             		...
             		onclick="window.location.href='8_Site_material_add.jsp'">
             	...
             	<input type = "submit" name="home" value="HOME" 
           		...
           		<input type="text" id="material_input" style = "float:right; background-color: #fff; height: 30px; width: 475px; border-radius: 15px" onkeyup="myFunction()" placeholder="	search by material name" title="Type in site name">&nbsp; &nbsp;
				
				<br><br>
				<input type = "submit" name="cal" value="Calculate Quantity for Individual Material" 
             		style = "margin:0px; padding:2px; background-color: #0b0470; color: white; height: 30px; width:300px;border-radius: 15px; float:right" 
             		onclick="window.location.href='8_Site_calculator.jsp'">
            	<br><br>
            	<br><br>
            	
            <table class="tg" id="MaterialDet" style="border:1px solid black;background-color:transparent;"> 
                <tr style="border:1px solid black;">
                    <th style="border:1px solid black;" class="tg-ggay">ID&nbsp; &nbsp; &nbsp; &nbsp;</th>
                    <th style="border:1px solid black;" class="tg-ggay">Material Name&nbsp; &nbsp; &nbsp; &nbsp;</th>
                ...
                <%
                     ...
                     String sql = "select * from bluelite.material order by materialID";
                ...
                %>
                     <tr style="border:1px solid blue;border-radius:3.5px">
                         <td style="border:1px solid blue;border-radius:3.5px" class="tg-fhq0"><%= rs.getInt("materialID") %></td>
                         <td style="border:1px solid blue;border-radius:3.5px" class="tg-fhq0"><%= rs.getString("materialName") %></td>
                         <td style="border:1px solid blue;border-radius:3.5px" class="tg-fhq0"><%= rs.getDouble("quantity") %></td>
                         <td style="border:1px solid blue;border-radius:3.5px;background-color: #AAFFF9;"><a href="8_Site_material_update.jsp?update_id=<%=rs.getInt("materialID")%>">Update</a></td>
                         <td style="border:1px solid blue;border-radius:3.5px;background-color: #AAFFF9;"><a href="8_Site_material_delete.jsp?delete_id=<%=rs.getInt("materialID")%>">Delete</a></td>
                     </tr>
