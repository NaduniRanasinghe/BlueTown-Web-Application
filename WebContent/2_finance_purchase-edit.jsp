  ...
  <div class="museBGSize clearfix borderbox" id="page"><!-- group -->
   ...
   <div class="clearfix grpelem" id="pu1447"><!-- group -->
    ...
    <div class="para1 clearfix grpelem" id="u1652-4"><!-- content -->
     <p>Edit Purchase Record</p>
    </div>
    <div class="grpelem" id="u2513" style="text-align: center"><!-- custom html -->
        <form action="Finance_EditPurchaseEntryController" method="post">
        <% 
        if(request.getParameter("edit_id")!=null)
        {
           ...
           try
           {
        	   ...
        	   pstmt = conn.prepareStatement("select * from bluelite.purchase where InvoiceNumber=?");
        	   pstmt.setInt(1,id);
        	   ...
        	   {     	
        %>
        	<input class="formtext" type="number" placeholder= "Invoice Number" name="invoiceNumber" value="<%=rs.getInt("InvoiceNumber")%>">
        	<br><br>
        	<input placeholder="Date" class="formtext" name= "date" type="text" onfocus="(this.type='date')" onblur="(this.type='text')" value="<%=rs.getString("Date") %>">
            <br><br>
            <input class="formtext" type="number" placeholder= "Seller ID" name="sellerID" value="<%=rs.getInt("SellerID")%>">
        	<br><br>
        	<input class="formtext" name="additional" placeholder="Additional Details" type="text" value="<%=rs.getString("AdditionalDetails") %>">
            <br><br>
        	<input class="formtext" name="value" placeholder= "Value" type="number" min="0" step="0.01" value="<%=rs.getDouble("Value") %>">
            <br><br>
            <input class="formbutton" type="submit"  name="edit" Value="Confirm">
            <br><br><a href="2_finance_revenue-information-portal.jsp"><input class="formbutton" type="button"  name="btn_back" value="Cancel"></a>
            <input type="hidden" name="hidden_id" value="<%=rs.getInt("InvoiceNumber")%>">
