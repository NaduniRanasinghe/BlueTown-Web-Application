...
if(typeof Muse == "undefined") window.Muse = {}; window.Muse.assets = {"required":["museutils.js", "museconfig.js", "jquery.musepolyfill.bgsize.js", "jquery.musemenu.js", "jquery.watch.js", "webpro.js", "musewpdisclosure.js", "require.js", "finance-manager-profile.css"], "outOfDate":[]};
</script>
  ...
  <link rel="stylesheet" type="text/css" href="css/new-finance-manager-profile.css?crc=3916206790" id="pagesheet"/>
  <!-- IE-only CSS -->
  <!--[if lt IE 9]>
  <link rel="stylesheet" type="text/css" href="css/iefonts_finance-manager-profile.css?crc=17042555"/>
  <![endif]-->
  <!-- Other scripts -->
  <script type="text/javascript">
 ...
 <body>
  <div class="museBGSize clearfix borderbox" id="page"><!-- group -->
   <div class="clearfix grpelem" id="pu133"><!-- group -->
    ...
    <nav class="MenuBar clearfix" id="menuu1060"><!-- horizontal box -->
     <div class="MenuItemContainer clearfix grpelem" id="u1068"><!-- vertical box -->
      <div class="MenuItem MenuItemWithSubMenu borderbox museBGSize clearfix colelem" id="u1069"><!-- horizontal box -->
       <div class="MenuItemLabel NoWrap clearfix grpelem" id="u1070-3"><!-- content -->
        <p>&nbsp;</p>
       </div>
      </div>
      <div class="SubMenu MenuLevel1 clearfix" id="u1073"><!-- vertical box -->
       <ul class="SubMenuView clearfix colelem" id="u1074"><!-- vertical box -->
        <li class="MenuItemContainer clearfix colelem" id="u1110"><!-- horizontal box --><div class="MenuItem MenuItemWithSubMenu rounded-corners clearfix grpelem" id="u1112"><!-- horizontal box --><div class="MenuItemLabel NoWrap clearfix grpelem" id="u1116-4"><!-- content --><div id="u1116-3"><p>Sign Out</p></div></div></div></li>
       </ul>
      </div>
     </div>
    </nav>
    <div class="clearfix" id="u1054-6"><!-- content -->
     <p id="u1054-2">Dushan Hemantha</p>
     <p id="u1054-4">Finance Manager</p>
    </div>
   </div>
   <div class="clearfix grpelem" id="pu1447"><!-- group -->
    ...
    <nav class="MenuBar clearfix grpelem" id="menuu669"><!-- horizontal box -->
     <div class="MenuItemContainer clearfix grpelem" id="u677"><!-- vertical box -->
      <div class="MenuItem MenuItemWithSubMenu borderbox rounded-corners clearfix colelem" id="u678"><!-- horizontal box -->
    ...
    <div class="grpelem" id="u1136"><!-- simple frame --></div>
    <div class="clip_frame grpelem" id="u1139"><!-- image -->
     <img class="block" id="u1139_img" src="images/dushan%20hemantha.png?crc=3982525326" alt="" data-heightwidthratio="1" data-image-width="143" data-image-height="143"/>
    </div>
    <div class="para1 clearfix grpelem" id="u1146-4"><!-- content -->
     <p>Hello Dushan!</p>
    </div>
    <div class="clearfix grpelem" id="u1149-14"><!-- content -->
     <p id="u1149-2">Name</p>
     <p id="u1149-4">NIC</p>
     <p id="u1149-6">Email</p>
     <p id="u1149-8">Mobile</p>
     <p id="u1149-10">Addres</p>
     <p id="u1149-12">Employee Since</p>
    </div>
    <div class="clearfix grpelem" id="u1155-14"><!-- content -->
     <p id="u1155-2">Dushan Hemantha</p>
     <p id="u1155-4">664135794V</p>
     <p id="u1155-6">fianancemgr@bluetown.com</p>
     <p id="u1155-8">0715489631</p>
     <p id="u1155-10">54/4, Medananda Road, Moratuwa.</p>
     <p id="u1155-12">06/April/2009</p>
    </div>
    ...
    <a href="2_finance_bill-information-portal.jsp"><button id="u1158"><p class="button-text">Utility Bills</p></button></a>
    <a href="2_finance_revenue-information-portal.jsp"><button id="u1170"><p class="button-text">Monthly Revenues</p></button></a>
    <a href="2_finance_asset-information-portal.jsp"><button id="u1161"><p class="button-text">Assets</p></button></a>
    <a href="2_finance_purchase-information-portal.jsp"><button id="u1167"><p class="button-text">Purchases</p></button></a>
    <a href="2_finance_net-profit-calculation.jsp"><button id="u1164"><p class="button-text">Profit Calculation</p></button></a>
    <a href="FinanceEntryReport"><button id="u1164444"><p class="button-text">Generate Report</p></button></a>
