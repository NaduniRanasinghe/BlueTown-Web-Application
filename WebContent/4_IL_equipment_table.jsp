...
<head>
    ...
    function myFunction() {
        ...
        table = document.getElementById("equip");
...
<div class="clearfix borderbox" id="page"><!-- group -->
    ...
    <div class="clearfix grpelem" id="pu1447"><!-- group -->
        ...
        <div class="para1 clearfix grpelem" id="u4039-4"><!-- content -->
            <p>Equipment Information Portal</p>
        </div>
        <div class="grpelem" id="invent1"><!-- custom html -->
            <style type="text/css">
                .tg  {margin-left: -140px;border-collapse:collapse;border-spacing:0;border-color:transparent;}
                .tg td{text-align: center; font-family:Arial, sans-serif;font-size:14px;padding:10px 13px;border-style:solid;border-width:1px;overflow:hidden;word-break:normal;border-top-width:1px;border-bottom-width:1px;border-color:#999;color:#444;background-color:#F7FDFA;}
            ...
            <input type = "submit" name="add" value="ADD EQUIPMENT" style = "background-color: gold; height: 30px; width: 150px;border-radius: 15px"
                 onclick="window.location.href='4_IL_equipment_add.jsp'">
            ...
            <table class="tg" id="equip">
                <tr>
                    <th class="tg-ggay">ID&nbsp; &nbsp; &nbsp; &nbsp;</th>
                    <th class="tg-ggay">Equipment Name&nbsp; &nbsp; &nbsp; &nbsp;</th>
                    <th class="tg-ggay">Quantity&nbsp; &nbsp; &nbsp; &nbsp;</th>
                    <th class="tg-ggay">Unit Price&nbsp; &nbsp; &nbsp; &nbsp;</th>
                    <th class="tg-ggay">Maintenance Charges&nbsp; &nbsp; &nbsp; &nbsp;</th>
                    <th class="tg-ggay">Total Expenses&nbsp; &nbsp; &nbsp; &nbsp;</th>
                    <th class="tg-ggay">Update&nbsp; &nbsp; &nbsp; &nbsp;</th>
                ...
                <%
                     ...
                     String sql = "select * from bluelite.equipment order by id;";
                ...
                %>
                     <tr>
                         ...
                         <td class="tg-fhq0"><%= rs.getInt("quantity") %></td>
                         <td class="tg-fhq0"><%= rs.getDouble("unit_cost") %></td>
                         <td class="tg-fhq0"><%= rs.getDouble("maintenance_cost") %></td>
                         <td class="tg-fhq0"><%= rs.getDouble("total") %></td>
                         <td><a href="4_IL_equipment_update.jsp?update_id=<%=rs.getInt("id")%>">Update</a></td>
                         <td><a href="4_IL_equipment_delete.jsp?delete_id=<%=rs.getInt("id")%>">Delete</a></td>
                     </tr>
