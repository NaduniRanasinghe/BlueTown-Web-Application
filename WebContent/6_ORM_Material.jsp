  ...
  <![endif]-->
	...
	<script>
	  function validate(form){
		  ...
		  var num = /^[0-9]+$/;
		  var mobile = /^[0-9]{10}$/;
		  var address = /^[#.0-9 a-z A-Z\s,-/]+$/;
		  
		  if(form.CompanyName.value == ""){
			  error.push("Error: Company Name cannot be kept null");
		  }
		  else if(!name.test(form.CompanyName.value)){
			  error.push("Error: Company Name contains Invalid characters");
		  }
		  if(form.address1.value == ""){
			  error.push("Error: Address 1 cannot be kept null");
		  }
		  else if(!address.test(form.address1.value)){
			  error.push("Error: Address 1 contains Invalid characters");
		  }
		  if(form.address2.value == ""){
			  error.push("Error: Address 2 cannot be kept null");
		  }
		  else if(!address.test(form.address2.value)){
			  error.push("Error: Address 2 contains Invalid characters");
		  }
		  if(form.city.value == ""){
			  error.push("Error: City cannot be kept null");
		  }
		  else if(!name.test(form.city.value)){
			  error.push("Error: City Name contains Invalid characters");
		  }
		  if(form.mobile.value == ""){
			  error.push("Error: Mobile field cannot be kept null");
		  }
		  else if(!mobile.test(form.mobile.value)){
			  error.push("Error: Mobile Number is Invalid");
		  }
		  if(form.itemName.value == ""){
			  error.push("Error: Item Name cannot be kept null");
		  }
		  else if(!name.test(form.itemName.value)){
			  error.push("Error: Item name contains Invalid characters");
		  }
		  if(form.unitPrice.value == ""){
			  error.push("Error: Unit Price cannot be kept null");
		  }
		  else if(!num.test(form.unitPrice.value)){
			  error.push("Error: Unit Price contains Invalid characters");
		  }
  ...
  <div class="museBGSize clearfix borderbox" id="page"><!-- group -->
   <div class="clearfix grpelem" id="pu133"><!-- group -->
    ...
    <div class="clearfix" id="u3532-6"><!-- content -->
     <p id="u3532-2">Hemantha Jayamanne</p>
     <p id="u3532-4">OR Manager</p>
    </div>
   ...
   <div class="clearfix grpelem" id="pu1447"><!-- group -->
    ...
    <div class="grpelem" id="u3128" style="text-align: center"><!-- custom html -->
        <form action="ORM_AddMet"method="post" style="float:center" onsubmit="return validate(this);">
              <input class="formtext" name="CompanyName" placeholder= " Company Name" type="text">
              <br><br>
              <input class="formtext" name="address1" placeholder= "Address Line 1" type="text">
              <br><br>
            <input class="formtext" name="address2" placeholder= "Address Line 2" type="text">
            <br><br>
            <input class="formtext" name="city" placeholder="City" type="text">
            <br><br>
            <input class="formtext" name="email" placeholder="Email" type="email">
            <br><br>
            <input class="formtext" name="mobile" placeholder="Mobile Number" type="text">
            <br><br>
            <input class="formtext" name="itemName" placeholder="Item Name" type="text">
            <br><br>
            <input class="formtext" name="unitPrice" placeholder="Unit Price" type="number">
            <br><br>
