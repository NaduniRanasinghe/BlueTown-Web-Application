  ...
  <script src="scripts/html5shiv.js?crc=4241844378" type="text/javascript"></script>
	...
	<script>
	     function validate(form){
	    	 ...
	    	 if(form.fname.value == ""){
	    		 error.push("Error: first name field cannot be null");
	    	 }
	    	 else if(!name.test(form.fname.value)){
	    		 error.push("Error: Invalid characters");
	    	 }
	    	 if(form.lname.value == ""){
	    		 error.push("Error: last name field cannot be null");
	    	 }
	    	 else if(!name.test(form.lname.value)){
	    		 error.push("Error: Invalid characters");
	    	 }
	    	 if(form.nic.value == ""){
	    		 error.push("Error: NIC field cannot be null");
	    	 }
	    	 else if(!nic.test(form.nic.value)){
	    		 error.push("Error: Invalid NIC Please enter a valid NIC");
	    	 }
	    	 if(form.mobilenum.value == ""){
	    		 error.push("Error: Mobile No. field cannot be null");
	    	 }
	    	 else if(!phone.test(form.mobilenum.value)){
	    		 error.push("Error: Invalid Number Please enter a valid phone number");
	    	 }
	  ...
	  <script type="text/javascript">
     	...
     	function demo(){
     		document.getElementById("nic").value="965292047v";
     		document.getElementById("fname").value="Hasalani";
     		document.getElementById("lname").value="Jayakody";
     		document.getElementById("address1").value="No 3";
     		document.getElementById("address2").value="Matara";
     		document.getElementById("mobilenum").value="0661234567";
     		document.getElementById("nic").value="965292047v";
     		document.getElementById("email").value="has@gmail.com";
     		document.getElementById("password").value="hasa123A";
     		document.getElementById("password1").value="hasa123A";
  ...
  <div class="museBGSize clearfix borderbox" id="page"><!-- group -->
   <div class="clearfix grpelem" id="pu133"><!-- group -->
    ...
    <div class="clearfix" id="u3532-6"><!-- content -->
     <p id="u3532-2">Kishan Samarakoon</p>
     <p id="u3532-4">HR Manager</p>
    </div>
    <nav class="MenuBar clearfix" id="menuu3533"><!-- horizontal box -->
     <div class="MenuItemContainer clearfix grpelem" id="u3534"><!-- vertical box -->
      <div class="MenuItem MenuItemWithSubMenu borderbox museBGSize clearfix colelem" id="u3535"><!-- horizontal box -->
   ...
   <div class="clearfix grpelem" id="pu1447"><!-- group -->
    ...
    <div class="grpelem" id="u3130"><!-- simple frame --></div>
    <div class="para1 clearfix grpelem" id="u3129-4"><!-- content -->
     <p>Employee Registration</p>
    </div>
    <div class="grpelem" id="u3128" style="text-align: center"><!-- custom html -->
        <form action="HR_AddEmployee" method= "post" style="float:center" onsubmit="return validate(this);">
        
              <input class="formtext" name="fname" id ="fname" placeholder= "First Name" type="text">
              <br><br>
              <input class="formtext" name="lname" id="lname" placeholder= "lastname" type="text">
              <br><br>
              <input class="formtext" name="nic" id="nic" placeholder= "NIC" type="text">
              <br><br>
            <select class="formmenu" name="department">
            ...
            <br><br>
            <select class="formmenu" name="position">
            ...
            <br><br>
              <input class="formtext" name="email" id="email" placeholder= "Email Address" type="email">
              <br><br>
            <input class="formtext" name="mobilenum" id="mobilenum" placeholder= "Mobile Number" type="text">
            <br><br>
            <input class="formtext" name="address1" id="address1" placeholder= "Address Line 1" type="text">
            <br><br>
            <input class="formtext" name="address2" id="address2" placeholder= "Address Line 2" type="text">
          
            <br><br>
            <select class="formmenu" name="gender">
            
            	<option>Male</option>
            	<option>Female</option>
            </select>
            <br><br>
            <input class="formtext" name="password1" id="password1" placeholder="Password" type="password"  pattern="(?=.*\d)(?=.*[a-z])(?=.*[A-Z]).{8,}" title="Must contain at least one number and one uppercase and lowercase letter, and at least 8 or more characters" required>
            <br><br>
            <input class="formtext" name="password" id="password" placeholder="Confirm Password" type="password">
            
            <br><br>
              <input class="formbutton" type="submit" name="btn_add">
        </form>

 <br><br>
        <button class="formbutton" style="width:220px;" value="Demo" onclick="demo()">Demo</button>
