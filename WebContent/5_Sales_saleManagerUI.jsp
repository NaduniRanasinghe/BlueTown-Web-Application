...
if(typeof Muse == "undefined") window.Muse = {}; window.Muse.assets = {"required":["museutils.js", "museconfig.js", "jquery.musepolyfill.bgsize.js", "jquery.musemenu.js", "jquery.watch.js", "webpro.js", "musewpdisclosure.js", "require.js", "sales-manager.css"], "outOfDate":[]};
</script>
  ...
  <link rel="stylesheet" type="text/css" href="css/sales-manager.css?crc=486493518" id="pagesheet"/>
  <!-- IE-only CSS -->
  <!--[if lt IE 9]>
  <link rel="stylesheet" type="text/css" href="css/iefonts_sales-manager.css?crc=440025506"/>
  <![endif]-->
  <!-- Other scripts -->
  <script type="text/javascript">
...
------------------------------------------------------------------------------->  
  ...
  <div class="museBGSize clearfix borderbox" id="page"><!-- group -->
   <div class="clearfix grpelem" id="pu133"><!-- group -->
    ...
    <nav class="MenuBar clearfix" id="menuu1468"><!-- horizontal box -->
     <div class="MenuItemContainer clearfix grpelem" id="u1469"><!-- vertical box -->
      <div class="MenuItem MenuItemWithSubMenu borderbox museBGSize clearfix colelem" id="u1479"><!-- horizontal box -->
       <div class="MenuItemLabel NoWrap clearfix grpelem" id="u1480-3"><!-- content -->
        <p>&nbsp;</p>
       </div>
      </div>
      <div class="SubMenu MenuLevel1 clearfix" id="u1470"><!-- vertical box -->
       <ul class="SubMenuView clearfix colelem" id="u1471"><!-- vertical box -->
        <li class="MenuItemContainer clearfix colelem" id="u1472"><!-- horizontal box --><div class="MenuItem MenuItemWithSubMenu rounded-corners clearfix grpelem" id="u1475"><!-- horizontal box --><div class="MenuItemLabel NoWrap clearfix grpelem" id="u1478-4"><!-- content --><div id="u1478-3"><p><a href="3_CRM_login.jsp">Sign Out</a></p></div></div></div></li>
       </ul>
      </div>
     </div>
    </nav>
...
%>
    ...
    <div class="clearfix" id="u1487-6"><!-- content -->
...
%>
   ...
   <div class="clearfix grpelem" id="pu1447"><!-- group -->
    ...
    <div class="grpelem" id="u1486"><!-- simple frame --></div>
    <div class="clearfix grpelem" id="u1465-4"><!-- content -->
     ...
     <form>
     <br>
<input class="MyButton" type="button" value="Condominium Management" onclick="window.location.href='5_Sales_addApartmentNew.jsp'" />
 <br>
 <input class="MyButton" type="button" value="Extra Features" onclick="window.location.href='5_Sales_addExtraFeaturesNew.jsp'" />
 <br>
 <input class="MyButton" type="button" value="Sale Management" onclick="window.location.href='5_Sales_addSalesNew.jsp'" />
 <br>
<input class="MyButton" type="button" value="Update Apartment" onclick="window.location.href='5_Sales_ApartmentInformationPortal.jsp'" />
 <br>
<input class="MyButton" type="button" value="Update Sales" onclick="window.location.href='5_Sales_salesInformationPortal.jsp'" />
 <br>

<input class="MyButton" type="button" value="Monthly Payment" onclick="window.location.href='5_Sales_testingCalc.jsp'" />
 <br>
 <input class="MyButton" type="button" value="Generate Report" onclick="window.location.href='http://localhost:8080/BlueTown/Sales_ReportApartment'" />
 <br>
</form>
