...
<div class="clearfix borderbox" id="page"><!-- group -->
    <div class="clearfix grpelem" id="pu133"><!-- group -->
        ...
        <div class="clearfix" id="u4013-6"><!-- content -->
            <p id="u4013-2">Dereesha Vithanage</p>
            <p id="u4013-4">Sales Manager</p>
        </div>
    ...
    <div class="clearfix grpelem" id="pu1447"><!-- group -->
        ...
        <div class="para1 clearfix grpelem" id="u4039-4"><!-- content -->
            <p>Customer Information Portal</p>
        </div>
	...
	<table>
            ...
            <table class="tg">
                <tr>
                    ...
                    <th class="tg-ggay">First name</th>
                    <th class="tg-ggay">Last name</th>
                    <th class="tg-ggay">Email</th>
                    <th class="tg-ggay">Mobile</th>
                    <th class="tg-ggay">Address Line1</th>
                    <th class="tg-ggay">Address Line2</th>
                    <th class="tg-ggay">City</th>
                    <th class="tg-ggay">Gender</th>
                    <th class="tg-ggay">ApartmentType</th>
                    <th class="tg-ggay">Site</th>
                    <th class="tg-ggay">Password</th>
                    <th class="tg-i0kf"><button class="button1">Edit</button></th>
                    <th class="tg-i0kf"><button class="button1">Delete<button></th>
                </tr>
...
if(query !=null){
	 ...
	 sql ="select * from bluelite.customer where cusid like '%"+query+"%' or nic like'%"+query+"%' or firstname like'%"+query+"%' or lastname like'%"+query+"%' or email like '%"+query+"%'or mobile like '%"+query+"%' or address1 like '%"+query+"%' or address2 like '%"+query+"%' or city like '%"+query+"%' or gender like '%"+query+"%' or apartmenttype like '%"+query+"%' or site like '%"+query+"%'";
}else{

sql ="select * from bluelite.customer ";
...
%>
                ...
                <tr>
                    ...
                    <td><a href="3_CRM_editCus.jsp?edit_id=<%=rs.getInt("cusid")%>">Edit</a></td>
                    <td><a href="3_CRM_deleteCus.jsp?delete_id=<%=rs.getInt("cusid")%>">Delete</a></td>
