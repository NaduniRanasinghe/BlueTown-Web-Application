  ...
  <![endif]-->
	...
	<script type="text/javascript"> 
	    ...
	    function total(form) {
	    	...
	    	var total = quan * cost + parseFloat(mCost);
  ...
  <div class="museBGSize clearfix borderbox" id="page"><!-- group -->
   ...
   <div class="clearfix grpelem" id="pu1447"><!-- group -->
    ...
    <div class="para1 clearfix grpelem" id="u1652-4"><!-- content -->
     <p>Equipment Inventory Form</p>
    </div>
    <div class="grpelem" id="u2513" style="text-align: center"><!-- custom html -->
    
        <form method="POST" action="IL_EquipmentAddController" style="float:center" onsubmit="return total(this);">
        
            <input class="formtext" name="type" placeholder="Equipment Name" type="text" pattern="^[a-z A-Z]+$" title="Please include characters(a-z A-Z) only!" required>
            <br><br>
            <input class="formtext" name="quantity" id="quantity" placeholder= "Quantity" type="number" min="0" required>
            <br><br>
            ...
            <br><br>
            <input class="formtext" name="maintenance_cost" id="maintenance_cost" placeholder= "Maintenance Charges" type="number" step="any" min="0" pattern="[0-9]*[.,]?[0-9]+" title="Please enter numerals or decimal values only" required>
            <br><br>
            <input type="hidden" name="hidden_total" id="hidden_total">
            <input class="formbutton" type="submit" name="add" value="INSERT">
