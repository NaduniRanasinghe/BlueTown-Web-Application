...
<head>
    ...
    <title>Site Information Portal</title>
    <!-- CSS -->
    ...
    function myFunction() {
     ...
     input = document.getElementById("site_input");
     filter = input.value.toUpperCase();
     table = document.getElementById("SiteDet");
...
<div class="clearfix borderbox" id="page"><!-- group -->
    <div class="clearfix grpelem" id="pu133"><!-- group -->
        ...
        <div class="clearfix" id="u4013-6"><!-- content -->
            <p id="u4013-2">Ravindu Madushan</p>
            <p id="u4013-4">Site Manager</p>
        </div>
    ...
    <div class="clearfix grpelem" id="pu1447"><!-- group -->
        ...
        <div class="para1 clearfix grpelem" id="u4039-4"><!-- content -->
            <p>Site Information Portal</p>
        </div>
        <div class="grpelem" id="invent1"><!-- custom html -->
            <style type="text/css">
                .tg  {margin-left:-50px; border-collapse:collapse;border-spacing:0;border-color:transparent;}
                .tg td{text-align: center; font-family:Arial, sans-serif;font-size:14px;padding:10px 13px;border-style:solid;border-width:0px;overflow:hidden;word-break:normal;border-top-width:1px;border-bottom-width:1px;border-color:#999;color:#444;background-color:#F7FDFA;}
            ...
            <div style="width:75%;">
            	...
            	<input type = "submit" name="add" value="ADD SITES" 
                 style = "margin:0px; padding:0px; background-color: #0b0470; color: white; height: 30px; width: 150px;border-radius: 15px; float:left"
                 onclick="window.location.href='8_Site_site_add.jsp'">
                 
                 <input type = "submit" name="home" value="HOME" 
             		style = "margin:0px; padding:0px; background-color: #000; color: white; height:20%; width:20%;border-radius: 15px; float:center" 
             		onclick="window.location.href='8_Site_site-manager-profile.jsp'">
            
            	<input type="text" id="site_input" style = "float:right; background-color: #fff; height: 30px; width: 475px; border-radius: 15px" onkeyup="myFunction()" placeholder="   search by site name" title="Type in site name">&nbsp; &nbsp;

				<br><br>
          		<br><br>
           
            <table class="tg" id="SiteDet" style="border:1px solid black;background-color:transparent;">
                <tr style="border:1px solid black">
                    <th class="tg-ggay" style="border:1px solid black;">ID</th>
                    <th class="tg-ggay" style="border:1px solid black;">Site Name&nbsp; &nbsp; &nbsp; &nbsp;</th>
                    <th class="tg-ggay" style="border:1px solid black;">Site Owner Name&nbsp; &nbsp; &nbsp; &nbsp;</th>
                    <th class="tg-ggay" style="border:1px solid black;">Estimated Cost&nbsp; &nbsp; &nbsp; &nbsp;</th>
                    <th class="tg-ggay" style="border:1px solid black;">Received Amount&nbsp; &nbsp; &nbsp; &nbsp;</th>
                    <th class="tg-ggay" style="border:1px solid black;">Hand Over Date&nbsp; &nbsp; &nbsp; &nbsp;</th>
                    <th class="tg-ggay" style="border:1px solid black;">Edit&nbsp; &nbsp; &nbsp; &nbsp;</th>
                    <th class="tg-ggay" style="border:1px solid black;">Delete</th>
                </tr>
                ...
                <%
                     ...
                     String sql = "select * from bluelite.sites2 order by siteID";
                     
                     rs = stmt.executeQuery(sql);
                     while(rs.next()){
                    	 
                %>
                     <tr style="border:1px solid blue;border-radius:3.5px">
                         <td style="border:1px solid blue;border-radius:3.5px" class="tg-fhq0"><%= rs.getInt("siteID") %></td>
                         <td style="border:1px solid blue;border-radius:3.5px" class="tg-fhq0"><%= rs.getString("siteName") %></td>
                         <td style="border:1px solid blue;border-radius:3.5px" class="tg-fhq0"><%= rs.getString("siteOwnerName") %></td>
                         <td style="border:1px solid blue;border-radius:3.5px" class="tg-fhq0"><%= rs.getDouble("estimatedCost") %></td>
                         <td style="border:1px solid blue;border-radius:3.5px" class="tg-fhq0"><%= rs.getDouble("receivedAmount") %></td>
                         <td style="border:1px solid blue;border-radius:3.5px" class="tg-fhq0"><%= rs.getString("handOverDate") %></td>
                         <td style="border:1px solid blue;border-radius:3.5px;background-color: #AAFFF9;"><a href="8_Site_site_update.jsp?update_id=<%=rs.getInt("siteID")%>">Update</a></td>
                         <td style="border:1px solid blue;border-radius:3.5px;background-color: #AAFFF9;"><a href="8_Site_site_delete.jsp?delete_id=<%=rs.getInt("siteID")%>">Delete</a></td>
                     </tr>
