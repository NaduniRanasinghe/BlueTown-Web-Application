...
<div class="clearfix borderbox" id="page"><!-- group -->
    ...
    <div class="clearfix grpelem" id="pu1447"><!-- group -->
        ...
        <div class="para1 clearfix grpelem" id="u4039-4"><!-- content -->
            <p>Human Resource Information Portal</p>
        </div>
			...
			<table>
					<tr>
						...
						<td  style="padding: 10px">
							<a href="HR.jsp"><button>Add New Record</button></a>
						</td>
					</tr>
				</table>
				<br><br>
...
if(query !=null){
	...
	sql ="select * from blueLite.hrportal where namehr like '%"+query+"%' or id like'%"+query+"%'";
}else{

sql ="select * from blueLite.hrportal";
...
%>
                  ...
                  <tr>
                    ...
                    <td class="tg-fhq0"><%=rs.getString("namehr")%></td>                                     
                   ...
                   <td class="tg-fhq0"><%=rs.getString("email")%></td>
                    ...
                    <td class="tg-fhq0"><a href="6_ORM_EditHR.jsp?edit_id=<%=rs.getInt("id")%>">Edit</a></td>
                  <td class="tg-fhq0"><a href="6_ORM_hrsupplierDelete.jsp?delete_id=<%=rs.getInt("id")%>">Delete</a></td>
