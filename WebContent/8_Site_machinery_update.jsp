...
<script type="text/javascript"> 
        function validate(form)
        {
        	...
        	//machinery Name field validation
            if(form.machineryName.value == ""){
              errors.push("Error: Machinery Name Field cannot be left empty!");         
            }
        ...
        <%
            if(request.getParameter("update_id")!=null) 
            {
                ...
                try
                {
                    ...
                    pstmt = conn.prepareStatement("select * from machinery where machineryID=?"); 
                    pstmt.setInt(1,id);
         ...
         <form method="POST" action="Site_MachineryUpdateController" style="float:center" onsubmit="return validate(this);">
            <input class="formtext" name="machineryName" required="" value="<%= rs.getString("machineryName") %>" placeholder="machinery Name" type="text">
            <br><br>
            <input class="formtext" name="quantity" required="" value="<%= rs.getDouble("quantity") %>" placeholder= "Quantity " type="number">
            <br><br>
            <input class="formbutton" type="submit" name="update" value="UPDATE">
            <input type="hidden" name="hidden_id" value="<%=rs.getInt("machineryID")%>">
