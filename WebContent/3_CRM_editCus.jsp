  ...
  <div class="museBGSize clearfix borderbox" id="page"><!-- group -->
   <div class="clearfix grpelem" id="pu133"><!-- group -->
    ...
    <div class="clearfix" id="u3532-6"><!-- content -->
     <p id="u3532-2">Dereesha Vithanag</p>
   ...
   <div class="clearfix grpelem" id="pu1447"><!-- group -->
    ...
    <div class="grpelem"  id="u3128" style="text-align: center"><!-- custom html -->
        <form action="CRM_editCus" method="post" style="float:center;">
        <%
            if(request.getParameter("edit_id")!=null) 
            {
                ...
                try
                {
                    ...
                    pstmt=connection.prepareStatement("select * from bluelite.customer where cusid=?"); 
                    pstmt.setInt(1,id);
                    ...
                    {
            %>  
            <input class="formtext" name="nic"  value="<%=rs.getString("nic")%>" placeholder= "NIC" type="text">
            <br><br>
            <input class="formtext" name="fname" value="<%=rs.getString("firstname")%>"  placeholder= "First Name" type="text">
            <br><br>
            <input class="formtext" name="lname" value="<%=rs.getString("lastname")%>"  placeholder="Last Name" type="text">
            <br><br>
            <input class="formtext" name="email" value="<%=rs.getString("email")%>"  placeholder="Email" type="email">
            <br><br>
            <input class="formtext" name="mobile" value="<%=rs.getString("mobile")%>"  placeholder="Mobile Number" type="text">
            <br><br>
            <input class="formtext" name="address1" value="<%=rs.getString("address1")%>" placeholder="Address Line 1" type="text">
            <br><br>
            <input class="formtext" name="address2" value="<%=rs.getString("address2")%>" placeholder="Address Line 2" type="text">
            <br><br>
            <input class="formtext" name="city" value="<%=rs.getString("city")%>" placeholder="City" type="text">
            <br><br> 
            ...
            <br><br>
            <input class="formtext" name="password" value="<%=rs.getString("password")%>" placeholder="Password" type="text" required>
            <br><br>
            <input class="formtext" name="password" value="<%=rs.getString("password")%>" placeholder="Confirm Password" type="text" required>
            <br><br>
            ...
            <br><br>
              <input class="formbutton" type="submit" name ="btn_edit" >
              <input type= "hidden" name="hidden_id" value="<%=rs.getInt("cusid")%>" >
               <%
                    }
