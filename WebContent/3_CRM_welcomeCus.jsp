...
if(typeof Muse == "undefined") window.Muse = {}; window.Muse.assets = {"required":["museutils.js", "museconfig.js", "jquery.musepolyfill.bgsize.js", "jquery.musemenu.js", "jquery.watch.js", "webpro.js", "musewpdisclosure.js", "require.js", "hr-manager-profile-copy.css"], "outOfDate":[]};
  ...
  <link rel="stylesheet" type="text/css" href="css/customer-profile.css?crc=4071978901" id="pagesheet"/>
  <!-- IE-only CSS -->
  <!--[if lt IE 9]>
     ...
     <div class="MenuItemContainer clearfix grpelem" id="u1296"><!-- vertical box -->
      ...
      <div class="SubMenu MenuLevel1 clearfix" id="u1301"><!-- vertical box -->
       <ul class="SubMenuView clearfix colelem" id="u1302"><!-- vertical box -->
        <li class="MenuItemContainer clearfix colelem" id="u1303"><!-- horizontal box --><div class="MenuItem MenuItemWithSubMenu rounded-corners clearfix grpelem" id="u1306"><!-- horizontal box --><div class="MenuItemLabel NoWrap clearfix grpelem" id="u1309-4"><!-- content --><div id="u1309-3"><a href = "http://localhost:8080/Test1/login.jsp"><button><p>Sign Out</p></button></a></div></div></div></li>
       </ul>
      </div>
     </div>
    </nav>
...
sql ="select * from blueLite.customer where nic like '%"+nic+"%' ";
...
while(rs.next()){
%>
            Welcome <%= rs.getString("firstname")%></p>
    </div>
    ...
    <div class="clearfix grpelem" id="u1317-14"><!-- content -->
     <p id="u1317-2"><%=rs.getString("firstname")%></p>
     <p id="u1317-4"><%=rs.getString("nic")%></p>
     <p id="u1317-6"><%=rs.getString("email")%></p>
     <p id="u1317-8"><%=rs.getString("mobile")%></p>
     <p id="u1317-10"><%=rs.getString("address1")%></p>
...
%>
    ...
    <div class="clip_frame grpelem" id="u1344"><!-- image -->
     <img class="block" id="u1344_img" src="images/mahendra.png?crc=3944624846" alt="" data-heightwidthratio="1" data-image-width="143" data-image-height="143"/>
    </div>
   </div>
  </div>
  <!-- JS includes -->
