  ...
  <div class="museBGSize clearfix borderbox" id="page"><!-- group -->
   ...
   <div class="clearfix grpelem" id="pu1447"><!-- group -->
    ...
    <div class="para1 clearfix grpelem" id="u1652-4"><!-- content -->
     <p>Logistics Inventory Form</p>
    </div>
    <div class="grpelem" id="u2513" style="text-align: center"><!-- custom html -->
    
        <form method="POST" action="IL_LogisticsAddController" style="float:center" onsubmit="return total(this);">
        
            <input class="formtext" name="type" placeholder="Vehicle Type" type="text" pattern="^[a-z A-Z]+$" title="Please include characters(a-z A-Z) only!" required>
            <br><br>
            <input class="formtext" name="cost" id="cost" placeholder= "Vehicle Cost" type="number" step="any" min="0" pattern="[0-9]*[.,]?[0-9]+" required>
            <br><br>
            <input class="formtext" name="maintenance_cost" id="maintenance_cost" placeholder= "Maintenance Charges" type="number" type="number" step="any" min="0" pattern="[0-9]*[.,]?[0-9]+" required>
            <br><br>
            <input class="formtext" name="fuel_cost" id="fuel_cost" placeholder= "Fuel Charges" type="number" type="number" step="any" min="0" pattern="[0-9]*[.,]?[0-9]+" required>
            <br><br>
