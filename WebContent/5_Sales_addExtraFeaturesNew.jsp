...
function validateFormNew() {
    ...
    var x = document.forms["myFormNew"]["name"].value;
    var y= document.forms["myFormNew"]["apartmentId"].value;
    var alpha = /^[a-zA-Z\s-, ]+$/;
    ...
    if (y =="" ) {
     ...
     if (isNaN(y) || x < 1) {
       alert("Inputs are not valid..Apartment ID should be numeric");
       return false;
   }else 
   		{
  ...
  <div class="museBGSize clearfix borderbox" id="page"><!-- group -->
   <div class="clearfix grpelem" id="pu133"><!-- group -->
    ...
    <div class="clearfix" id="u3710-6"><!-- content -->
     ...
     <p id="u3710-4">Apartment Handller</p>
    </div>
   </div>
   <div class="clearfix grpelem" id="pu1447"><!-- group -->
    ...
    <div class="grpelem" id="u3666" style="text-align: center"><!-- custom html -->
        ...
        <form  action="Sales_AddFeatures" name="myFormNew" method="post" onsubmit="return validateFormNew()" style="float:center;">
            
            
             <input class="formtext" name="apartmentId" placeholder= "Apartment ID" type="text">
            <br><br>
            ...
            <select class="formmenu" name="bathroom">
            ...
            <select class="formmenu" name="sRoom">
                <option value="Yes">Yes</option>
                <option value="No">No</option>
            </select>
            <br><br>
            <input class="formbutton" name= "btn_add" type="submit" onclick="validateFormNew()" >
        </form>
