...
if(typeof Muse == "undefined") window.Muse = {}; window.Muse.assets = {"required":["museutils.js", "museconfig.js", "jquery.musepolyfill.bgsize.js", "jquery.musemenu.js", "jquery.watch.js", "webpro.js", "musewpdisclosure.js", "require.js", "new-finance-entry.css"], "outOfDate":[]};
  ...
  <title>Edit Revenue Record</title>
  <!-- CSS -->
  ...
  <link rel="stylesheet" type="text/css" href="css/net-profit-calculation.css?crc=3904585476" id="pagesheet"/>
  <!-- IE-only CSS -->
  <!--[if lt IE 9]>
 ...
 <body onload="calc()">
  ...
  <div class="museBGSize clearfix borderbox" id="page"><!-- group -->
   ...
   <div class="clearfix grpelem" id="pu1447"><!-- group -->
    ...
    <div class="grpelem" id="u2513" style="text-align: center; font-family: lato"><!-- custom html -->
        <form action="" method="post">
        <br><br>
        <div style="font-size: 20px">
        <p style="color: white" id= "revenuedisplay"></p><br>
        <p style="color: white" id= "assetdisplay"></p><br>
        <p style="color: white" id= "billdisplay"></p><br>
		<p style="color: white" id= "purchasedisplay"></p><br><br>
		
		<p style="color: white; padding-bottom: 10px">Net Profit:</p>
        <p style="color: white; font-size: 30px" id= "totaldisplay"></p><br> 
        </div>       
        
        <br><br>
        <a href="2_finance_finance-manager-profile.jsp"><input class="formbutton" type="button"  name="btn_back" value="Back"></a>
        <% 
           ...
           try
           {
        	   ...
        	   pstmt = conn.prepareStatement("select * from bluelite.assetsum");
        	   pstmt1 = conn.prepareStatement("select * from bluelite.billsum");
        	   pstmt2 = conn.prepareStatement("select * from bluelite.purchasesum");
        	   pstmt3 = conn.prepareStatement("select * from bluelite.revenuesum");
        	   ...
        	   {     	
        %>
            <input class="formtext" id="asset" name="asset" placeholder="Year" type="hidden" value="<%=rs.getDouble("Asset") %>">
            <br><br>
        <%
        	   }
        	   ...
        	   {     	
        %>	   
            <input class="formtext" id="bill" name="bill" placeholder="Year" type="hidden" value="<%=rs1.getDouble("Bill") %>">
            <br><br>
        <%
        	   }
        	   ...
        	   {     	
        %>
            <input class="formtext" id="purchase" name="purchase" placeholder="Year" type="hidden" value="<%=rs2.getDouble("Purchase") %>">
            <br><br>
        <%
        	   }
        	   ...
        	   {     	
        %>
            <input class="formtext" id="revenue" name="revenue" placeholder="Year" type="hidden" value="<%=rs3.getDouble("Revenue") %>">
            <br><br>
			
			<input class="formtext" id="total" name="total" placeholder="" type="hidden">
            <br><br>
...
<script>
	...
	function calc() {
		...
		document.getElementById("revenuedisplay").innerHTML = "Revenues: Rs. " + revenue + "0";
		document.getElementById("assetdisplay").innerHTML = "Assets: Rs. " + asset +"0";
		document.getElementById("billdisplay").innerHTML = "Bills: Rs. " + bill + "0";
		document.getElementById("purchasedisplay").innerHTML = "Purchase: Rs. " + purchase + "0";
		document.getElementById("totaldisplay").innerHTML = Number(revenue)  + Number(asset) - Number(purchase) + - Number(bill);
