           ...
           <%
            if(request.getParameter("edit_id")!=null) 
            {
                ...
                try
                {
                    ...
                    pstmt=connection.prepareStatement("select * from bluelite.task where id=?"); 
                    pstmt.setInt(1,id);
                    ...
                    {
            %>
            <input class="formtext" name="taskname" value="<%=rs.getString("taskname")%>" type="text">
            <br><br>
            
            <input placeholder="Date" name="date"  class="formtext" value="<%=rs.getString("date")%>" type ="text">
            <br><br>
            <input class="formtext" name="description"  value="<%=rs.getString("description")%>" type="text">
            
            <br><br>
            <input class="formtext" name="budget"  value="<%=rs.getDouble("Budget")%>" type="text">
            <br><br>
