  ...
  <div class="museBGSize clearfix borderbox" id="page"><!-- group -->
   ...
   <div class="clearfix grpelem" id="pu1447"><!-- group -->
    ...
    <div class="grpelem" id="u2513" style="text-align: center"><!-- custom html -->
        <form action="Event_AddTask" method="post" style="float:center;">
            <input class="formtext" name="taskname" placeholder= "Task Name" type="text">
            <br><br>
            <input placeholder="DueDate" name="duedate" class="formtext" type="text" onfocus="(this.type='date')" onblur="(this.type='text')" id="date">
			 <br><br>
            <input class="formtext" name="description" placeholder= "Desciption" type="text">
            <br><br>           
            <input class="formtext" name="budget" placeholder= " Budget" type="number">
            <br><br>
